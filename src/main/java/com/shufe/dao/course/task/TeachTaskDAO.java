...
public interface TeachTaskDAO extends BasicDAO {
   ...
   * @return
   */
  public List getTeachDepartsOfTask(Long[] stdTypeIds, Long[] teachDepartIds, TeachCalendar calendar);
   ...
   * @return
   */
  public List getCourseTypesOfTask(Long[] stdTypeIds, Long[] teachDepartIds, TeachCalendar calendar);
