...
public abstract class TeachTaskFilterCategory {
   ...
   * 从开课部门角度过滤
   */
  public static final TeachTaskFilterCategory TEACHDEPART = new TeachTaskFilterCategory("teachDepart") {
   ...
   * 从上课部门角度过滤
   */
  public static final TeachTaskFilterCategory DEPART = new TeachTaskFilterCategory("depart") {
    public String getFilterString() {
   ...
   * 从专业角度过滤
   */
  public static final TeachTaskFilterCategory SPECIALITY = new TeachTaskFilterCategory("speciality") {
    public String getFilterString() {
   ...
   * 从专业方向角度过滤
   */
  public static final TeachTaskFilterCategory SPECIALITY_ASPECT = new TeachTaskFilterCategory("aspect") {
    public String getFilterString() {
   ...
   * 从行政班级角度过滤
   */
  public static final TeachTaskFilterCategory ADMINCLASS = new TeachTaskFilterCategory("adminClass") {
    public String getFilterString() {
      return " inner join task.teachClass.adminClasses as adminClass " + "where adminClass.id= :id ";
    }
  };
   ...
   * 从课程类别角度过滤
   */
  public static final TeachTaskFilterCategory COURSETYPE = new TeachTaskFilterCategory("courseType") {
    public String getFilterString() {
   ...
   * 从学生类别角度过滤
   */
  public static final TeachTaskFilterCategory STDTYPE = new TeachTaskFilterCategory("stdType") {
    public String getFilterString() {
   ...
   * 从教师角度过滤
   */
  public static final TeachTaskFilterCategory TEACHER = new TeachTaskFilterCategory("teacher") {
    public String getFilterString() {
      return " join task.arrangeInfo.teachers as teacher" + " where teacher.id = :id ";
    }
  };
   ...
   */
  public static final TeachTaskFilterCategory STD = new TeachTaskFilterCategory("std") {
    public String getFilterString() {
      return " join task.teachClass.courseTakes as takeInfo" + " where (takeInfo.student.id= :id)";
    }
  };
  static {
