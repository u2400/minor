...
public class CourseActivityDAOHibernate extends BasicHibernateDAO implements CourseActivityDAO {
  ...
  public void removeActivities(Collection tasks) {
    ...
    teachTaskDAO.updateTeachTaskByIds("arrangeInfo.isArrangeComplete", Boolean.FALSE, taskIds);
