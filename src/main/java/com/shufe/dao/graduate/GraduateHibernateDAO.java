...
public class GraduateHibernateDAO extends BasicHibernateDAO implements GraduateDAO {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.dao.graduate.GraduateDAO#searchAuditStandard(com.shufe.model.graduate.AuditStandard,
   * int, int)
   */
  ...
  /*
   * (non-Javadoc)
   * @see com.shufe.dao.graduate.GraduateDAO#searchAuditStandardWithNull(com.shufe.model.graduate.
   * AuditStandard)
   */
  ...
  /*
   * (non-Javadoc)
   * @see com.shufe.dao.graduate.GraduateDAO#countAuditStandardWithNull(com.shufe.model.graduate.
   * AuditStandard)
   */
  public int countAuditStandardWithNull(AuditStandard auditStandard) {
    ...
    if (auditStandard.getId() != null) {
      criteria.add(Restrictions.sqlRestriction("{alias}.auditStandardId != ?", auditStandard.getId(),
          Hibernate.LONG));
    }
  ...
  private Criteria generateAuditStandardCriteria(AuditStandard auditStandard) {
    ...
    criteria.add(Example.create(auditStandard).setPropertySelector(new NotEmptyPropertySelector()));
