...
public class CriterionUtils {
  ...
  public static List getEntityCriterions(String nestedName, Object entity, String[] excludePropertes,
    ...
    if (null == entity) { return Collections.EMPTY_LIST; }
  ...
  private static void addCriterion(String nestedName, Object entity, String[] excludePropertes, String path,
      Object value, List criterions, MatchMode mode, boolean ignoreZero) {
  ...
  private static List getComponentCriterions(String nestedName, Object entity, String property,
    ...
    if (null == component) { return Collections.EMPTY_LIST; }
