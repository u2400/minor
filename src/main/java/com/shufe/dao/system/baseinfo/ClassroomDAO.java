...
public interface ClassroomDAO extends BasicDAO {
   ...
   * @return
   */
  public Pagination getClassrooms(Classroom classroom, Long[] departIds, int pageNo, int pageSize);
   ...
   * @return
   */
  public Pagination getAllClassrooms(Classroom classroom, Long[] departIds, int pageNo, int pageSize);
