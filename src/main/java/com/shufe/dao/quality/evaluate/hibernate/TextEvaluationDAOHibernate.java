 ...
 */
public class TextEvaluationDAOHibernate extends BasicHibernateDAO implements TextEvaluationDAO {
  /*
   * (non-Javadoc)
  ...
  public void updateForAffirm(Long[] textEvaluationIds, Boolean isAffirm) {
    this.getSession()
        ...
        .setParameterList("textEvaluationIds", textEvaluationIds).executeUpdate();
  }
}
