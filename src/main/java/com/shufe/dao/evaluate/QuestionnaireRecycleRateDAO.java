...
public interface QuestionnaireRecycleRateDAO extends BasicDAO {
   ...
   * @return
   */
  public abstract List getRecycleRateObjects(String deparmtentIds, String studentTypeIds,
   ...
   * @return
   */
  public abstract List getAllRateByCourseTask(String departmentIds, String studentTypeIds,
   ...
   * @return
   */
  public abstract List getDetailInfoOfTask(String departmentIds, String departmentId, String studentTypeIds,
