...
public class ModulusDAOHibernate extends BasicHibernateDAO implements ModulusDAO {
  ...
  public Criteria getModuls(Object depencyObject, String studentTypeIds) {
    ...
    if (depencyObject.getClass().equals(TeachModulus.class)) {
      ...
      if (null != teachModulus.getMinPeople() && !new Integer(0).equals(teachModulus.getMinPeople())) {
  ...
  /**
   * @see com.shufe.dao.workload.ModulusDAO#getModulus(java.lang.Object, java.lang.String)
   */
   ...
   * 分页对象
   * 
   * @see com.shufe.dao.workload.ModulusDAO#getPagiOfModulus(java.lang.Object, java.lang.String,
   *      int, int)
   */
   ...
   * 得到系数的属性值
   * 
   * @see com.shufe.dao.workload.ModulusDAO#getPropertyOfModulus(java.lang.Object, java.lang.String,
   *      java.lang.String)
   */
