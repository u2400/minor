...
public interface TeachWorkloadDAO extends BasicDAO {
  ...
  /**
   * @see com.shufe.dao.workload.StatisticDAO#getStatistics(java.lang.String, java.lang.Long)
   */
   ...
   */
  public abstract Criteria getExampleTeachWorkloads(TeachWorkload teachWorkload, String stdTypeIdSeq,
   ...
   * @return
   */
  public abstract List getTeachWorkloads(Long teacherId, Long studentTypeId, String year, String term);
   ...
   * @param b
   */
  public abstract void updateAffirmAll(String departmentIds, String typeName, boolean b);
   ...
   * @return
   */
  public abstract List getTasksOfTeacherByChargeDepart(String stdTypeSeq, String departIdSeq,
      String teachCalendarIdSeq);
