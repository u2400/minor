...
public class TeachCategoryDAOHibernate extends BasicHibernateDAO implements TeachCategoryDAO {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.dao.workload.TeachCategoryDAO12#getTeachCategoryBystdTypeAndcourseType(java.lang.
   * Long, java.lang.Long)
   */
  public TeachCategory getTeachCategoryBystdTypeAndcourseType(Long stdTypeId, Long courseTypeId) {
    ...
    if (criteria.list().size() > 0) return (TeachCategory) criteria.list().get(0);
    return null;
  }
}
