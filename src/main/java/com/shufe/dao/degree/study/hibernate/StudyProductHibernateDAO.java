...
public class StudyProductHibernateDAO extends BasicHibernateDAO implements StudyProductDAO {
   ...
   * @return
   */
  private Criteria getExampleStudyProduct(Object studyProduct, String departIdSeq, String stdTypeSeq) {
    Criteria criteria = getSession().createCriteria(studyProduct.getClass());
   ...
   * 得到论文的属性值
   * 
   * @see com.shufe.dao.degree.study.StudyProductDAO#getStdPropertyProduct(com.shufe.model.degree.study.StudyThesis,
   *      java.lang.String, java.lang.String, java.lang.String, boolean)
   */
  public List getStdPropertyProduct(Object studyProduct, String departIdSeq, String stdTypeSeq,
      String properties, boolean isDistinctStdNo) {
    Criteria criteria = getExampleStudyProduct(studyProduct, departIdSeq, stdTypeSeq);
   ...
   * 更新列表属性
   * 
   * @see com.shufe.dao.degree.study.StudyProductDAO#batchUpdate(java.lang.String,
   *      java.lang.String[], java.lang.Object[], java.lang.String)
   */
  public void batchUpdate(String entityName, String[] properties, Object[] values, String idSeq) {
    String updateSql = "update " + StringUtils.capitalize(entityName) + " set ";
  ...
  public void batchDelete(String entityName, String idSeq) {
    String deleteSql = "delete " + StringUtils.capitalize(entityName) + " where id in(:ids)";
    if (StringUtils.isNotBlank(idSeq)) {
