...
public class TopicOpenHibernateDAO extends BasicHibernateDAO implements TopicOpenDAO {
   ...
   * @return
   */
  private Criteria doGetNoOpenedCriter(Student student, String departmentIdSeq, String stdTypeIdSeq) {
   ...
   * @param IdSeq
   */
  public void batchUpdateProperty(String entityName, String[] propertys, Object[] values, String IdSeq) {
