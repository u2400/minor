...
public class Level2SubjectDAOHibernate extends BasicHibernateDAO implements Level2SubjectDAO {
  ...
  private Criteria buildLevel2subjectCriteria(Level2Subject subject) {
    ...
    if (null != subject && null != subject.getLevel1Subject()) {
      ...
      List categoryCriterions = CriterionUtils.getEntityCriterions("level1Subject.",
          subject.getLevel1Subject());
    ...
    if (null != subject && null != subject.getSpeciality()) {
      ...
      List categoryCriterions = CriterionUtils.getEntityCriterions("speciality.", subject.getSpeciality());
      if (!categoryCriterions.isEmpty()) {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.dao.subject.Level2SubjectDAO#getDepartsOfSpeciality(com.shufe.model.subject.Level2Subject
   * )
   */
