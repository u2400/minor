...
public class RankOfTeachProduct extends LongIdObject {
  ...
  public boolean equals(Object object) {
    if (!(object instanceof RankOfTeachProduct)) { return false; }
    RankOfTeachProduct rhs = (RankOfTeachProduct) object;
    return new EqualsBuilder().appendSuper(super.equals(object)).append(this.rank, rhs.rank)
        .append(this.teacher.getId(), rhs.teacher.getId()).isEquals();
  }
   ...
   */
  public int hashCode() {
    return new HashCodeBuilder(-1426781437, -1462025883).appendSuper(super.hashCode()).append(this.rank)
