...
public class StudentStatusInfo extends LongIdObject implements Serializable {
   ...
   */
  public void setDegreeBeforEnrollOrganization(String degreeBeforEnrollOrganization) {
   ...
   */
  public void setEducationBeforEnrollSpeciality(String educationBeforEnrollSpeciality) {
