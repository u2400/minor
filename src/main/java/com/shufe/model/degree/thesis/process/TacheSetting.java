...
public class TacheSetting extends LongIdObject implements Comparable {
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    for (Iterator iter = this.getThesisDocuments().iterator(); iter.hasNext();) {
  ...
  public int compareTo(Object object) {
    ...
    return new CompareToBuilder()
        .append(myClass.getSchedule().getEnrollYear(), this.getSchedule().getEnrollYear())
        .append(myClass.getSchedule().getStudentType().getName(),
            this.getSchedule().getStudentType().getName())
        .append(this.getSchedule().getStudyLength(), myClass.getSchedule().getStudyLength())
        .append(this.getPlanedTimeOn(), myClass.getPlanedTimeOn()).toComparison();
  }
