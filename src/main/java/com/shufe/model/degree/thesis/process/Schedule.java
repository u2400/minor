...
public class Schedule extends LongIdObject implements Cloneable {
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.studyLength, rhs.studyLength)
        .append(this.studentType, rhs.studentType).append(this.enrollYear, rhs.enrollYear).isEquals();
  }
   ...
   */
  public int hashCode() {
    return new HashCodeBuilder(-774925725, 1497404811).append(this.studyLength).append(this.studentType)
        .append(this.enrollYear).toHashCode();
  }
}
