...
public class AnswerTeam extends LongIdObject {
  ...
  public boolean checkedId() {
    boolean flag = false;
    if (null != this && null != this.getId() && !new Long(0).equals(this.getId())) {
      flag = true;
    }
    return flag;
  }
  ...
  public boolean equals(Object object) {
    if (!(object instanceof AnswerTeam)) { return false; }
    AnswerTeam rhs = (AnswerTeam) object;
    return new EqualsBuilder().append(this.specialityAspect, rhs.specialityAspect)
        .append(this.depart, rhs.depart).append(this.name, rhs.name).isEquals();
  }
