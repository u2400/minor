...
public class ThesisIndex extends LongIdObject implements Comparable {
  ...
  public int compareTo(Object object) {
    ...
    return new CompareToBuilder().append(this.thesisIndexType.getCode(), myClass.thesisIndexType.getCode())
        .append(this.thesisIndexNo, myClass.thesisIndexNo).toComparison();
  }
}
