...
public class DutyRecordStatisticsStd {
  ...
  public boolean equals(Object object) {
    if (!(object instanceof DutyRecordStatisticsStd)) { return false; }
  ...
  public String toString() {
    return new ToStringBuilder(this).append("id", this.getId()).append("Name", this.getName())
        .append("EngName", this.getEngName()).toString();
  }
