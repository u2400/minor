...
public class DutyRecordStatisticsCourse {
  ...
  public DutyRecordStatisticsCourse(String dutyRecordId, String teachTaskId, String courseId, String name,
      String engName) {
  ...
  public DutyRecordStatisticsCourse(DutyRecord dutyRecord) {
    this(String.valueOf(dutyRecord.getId()), String.valueOf(dutyRecord.getTeachTask().getId()), String
        .valueOf(dutyRecord.getTeachTask().getCourse().getId()), dutyRecord.getTeachTask().getCourse()
        .getName(), dutyRecord.getTeachTask().getCourse().getEngName());
  }
  ...
  public boolean equals(Object object) {
    if (!(object instanceof DutyRecordStatisticsCourse)) { return false; }
    DutyRecordStatisticsCourse dutyRecordStatisticsStd = (DutyRecordStatisticsCourse) object;
    return new EqualsBuilder().append(this.getTeachTaskId(), dutyRecordStatisticsStd.getTeachTaskId())
        .isEquals();
  }
  ...
  public String toString() {
    return new ToStringBuilder(this).append("DutyRecordId", this.getDutyRecordId())
        .append("TeachTaskId", this.getTeachTaskId()).append("CourseId", this.getCourseId())
        .append("Name", this.getName()).append("EngName", this.getEngName()).toString();
  }
}
