...
public class DataRealm implements Component, Serializable {
  ...
  public static DataRealm mergeAll(List realms) {
    ...
    if (CollectionUtils.isEmpty(realms)) { return realm; }
  ...
  public DataRealm merge(DataRealm other) {
    if (null == other) return this;
      ...
      setDepartmentIdSeq(evictComma(SeqStringUtil.mergeSeq(getDepartmentIdSeq(), other.getDepartmentIdSeq())));
      setStudentTypeIdSeq(evictComma(SeqStringUtil.mergeSeq(getStudentTypeIdSeq(),
          other.getStudentTypeIdSeq())));
      return this;
    }
  }
  ...
  public DataRealm shrink(DataRealm other) {
    if (null == other) return this;
      ...
      setDepartmentIdSeq(evictComma(SeqStringUtil.subtractSeq(getDepartmentIdSeq(),
          other.getDepartmentIdSeq())));
      setStudentTypeIdSeq(evictComma(SeqStringUtil.subtractSeq(getStudentTypeIdSeq(),
          other.getStudentTypeIdSeq())));
      return this;
    }
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
        .append("studentTypeIdSeq", this.studentTypeIdSeq).append("departmentIdSeq", this.departmentIdSeq)
        .toString();
  }
}
