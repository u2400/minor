 ...
 */
public class Department extends BaseInfo implements Comparable, com.ekingstar.eams.system.baseinfo.Department {
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("name", this.getName())
