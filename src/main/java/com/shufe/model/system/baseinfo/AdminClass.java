...
public class AdminClass extends BaseInfo implements Serializable {
  ...
  public boolean equals(Object object) {
    if (!(object instanceof AdminClass)) { return false; }
   ...
   */
  public int hashCode() {
    return new HashCodeBuilder(547046601, -323178581).append(this.getId()).toHashCode();
  }
  ...
  public int freeCapacity() {
    if (null != getPlanStdCount() && null != getActualStdCount()) {
      return getPlanStdCount().intValue() - getActualStdCount().intValue();
    } else {
      return 0;
    }
  }
