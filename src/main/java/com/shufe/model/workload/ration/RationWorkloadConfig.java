...
public class RationWorkloadConfig extends LongIdObject {
  ...
  public boolean equals(Object object) {
    if (!(object instanceof RationWorkloadConfig)) { return false; }
    RationWorkloadConfig rhs = (RationWorkloadConfig) object;
    return new EqualsBuilder().appendSuper(super.equals(object))
        .append(this.teachCalendar.getId(), rhs.teachCalendar.getId())
        .append(this.rationWorkload.getId(), rhs.rationWorkload.getId())
        .append(this.department.getId(), rhs.department.getId()).isEquals();
  }
