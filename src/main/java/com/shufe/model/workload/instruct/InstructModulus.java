...
public class InstructModulus extends Modulus {
  ...
  public boolean isSame(Object object) {
    if (!(object instanceof InstructModulus)) { return false; }
    InstructModulus rhs = (InstructModulus) object;
    return new EqualsBuilder().append(getStudentType(), rhs.getStudentType())
        .append(getItemType(), rhs.getItemType()).isEquals();
  }
