...
public class TeachCommon implements Component {
  ...
  public String toString() {
    ...
    if (null != enrollTurn) buffer.append(" " + enrollTurn);
    if (null != stdType) buffer.append(" " + stdType.getName());
    if (null != depart) buffer.append(" " + depart.getName());
    if (null != speciality && StringUtils.isNotEmpty(speciality.getName())) buffer.append(" "
        + speciality.getName());
    if (null != aspect && StringUtils.isNotEmpty(aspect.getName())) buffer.append(" " + aspect.getName());
