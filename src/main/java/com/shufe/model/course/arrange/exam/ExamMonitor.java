...
public class ExamMonitor extends LongIdObject {
  ...
  public boolean isSameMonitor(ExamMonitor other) {
    boolean sameTeacher = ObjectUtils.equals(getExaminer(), other.getExaminer());
    sameTeacher &= ObjectUtils.equals(getInvigilator(), other.getInvigilator());
    sameTeacher &= ObjectUtils.equals(getExaminerName(), other.getExaminerName());
    sameTeacher &= ObjectUtils.equals(getInvigilatorName(), other.getInvigilatorName());
