...
public class CourseArrangeSwitch extends LongIdObject {
  ...
  /** 是否显示上课地点 */
  private Boolean isArrangeAddress;
  ...
  public Boolean getIsArrangeAddress() {
    return isArrangeAddress;
  }

  public void setIsArrangeAddress(Boolean isArrangeAddress) {
    this.isArrangeAddress = isArrangeAddress;
  }
