...
public class StdCreditConstraint extends CreditConstraint {
  ...
  public void addElectedCredit(Float credit) {
    if (null == getElectedCredit()) {
      ...
      setElectedCredit(new Float(credit.floatValue() + getElectedCredit().floatValue()));
    }
  }
  ...
  public void removeElectedCredit(Float removedCredit) {
    float credit = (null != getElectedCredit()) ? getElectedCredit().floatValue() : 0;
  ...
  public boolean checkElectable(Float credit) {
    return (((getElectedCredit() == null) ? 0 : getElectedCredit().floatValue()) + credit.floatValue()) <= (((getAwardedCredit() == null) ? 0
        : getAwardedCredit().intValue()) + ((getMaxCredit() == null) ? 0 : getMaxCredit().intValue()));
  }
