...
public class GradeAchivement extends LongIdObject {
  ...
  public String getIeScoreText() {
    return ((null == ieScore) ? "" : ieScore.toString()) + (iePassed ? "全部及格" : "有不及格");
  }
  ...
  public String getPeScoreText() {
    return ((null == peScore) ? "" : peScore.toString()) + (pePassed ? "全部及格" : "有不及格");
  }
