...
public class Textbook extends LongIdObject {
  ...
  /** 获奖等级 */
  private TextbookAwardLevel awardLevel;
  ...
  public Float getOnSell() {
    return onSell;
  }

  public void setOnSell(Float onSell) {
    this.onSell = onSell;
  }
  ...
  public boolean equals(Object object) {
    if (!(object instanceof Textbook)) { return false; }
   ...
   */
  public int hashCode() {
    return new HashCodeBuilder(-1123717217, -609864545).append(this.getId()).toHashCode();
  }
