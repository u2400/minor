...
public class PlanCourse extends LongIdObject implements Comparable, Cloneable {
  ...
  public boolean isSame(Object object) {
    ...
    return new EqualsBuilder().append(getHSKDegree(), rhs.getHSKDegree())
        .append(getTermSeq(), rhs.getTermSeq()).append(getRemark(), rhs.getRemark())
        .append(getTeachDepart().getId(), rhs.getTeachDepart().getId())
        .append(getCourse().getId(), rhs.getCourse().getId()).append(getId(), rhs.getId()).isEquals();
  }
