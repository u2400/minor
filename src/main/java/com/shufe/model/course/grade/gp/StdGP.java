...
public class StdGP {
   ...
   * @see StdGPPerTerm
   */
  private List<StdGPPerTerm> GPList;
  ...
  private Map<TeachCalendar, StdGPPerTerm> calendarGP;

  public StdGP(Student std) {
    this.std = std;
    this.GPList = new ArrayList<StdGPPerTerm>();
  ...
  public Float getGP(TeachCalendar calendar) {
    ...
    return null == gpterm ? null : gpterm.getGPA();
  }

  public StdGPPerTerm getStdGPPerTerm(TeachCalendar calendar) {
    if (null == calendarGP) {
      calendarGP = new HashMap<TeachCalendar, StdGPPerTerm>();
      for (StdGPPerTerm gpterm : getGPList()) {
  ...
  public List<StdGPPerTerm> getGPList() {
    return GPList;
  }

  public void setGPList(List<StdGPPerTerm> list) {
    GPList = list;
  }
