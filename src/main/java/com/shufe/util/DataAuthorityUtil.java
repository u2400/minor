...
public class DataAuthorityUtil {
  ...
  static {
    ...
    predicates.put("Student", new DataAuthorityPredicate("", "", "type", "department"));
  }
  ...
  public static boolean isInDataRealm(String category, Object entity, String stdTypeIdSeq, String departIdSeq) {
    return getPredicate(category, entity, stdTypeIdSeq, departIdSeq).evaluate(entity);
  }
  ...
  private static DataAuthorityPredicate getPredicate(String category, Object entity, String stdTypeIdSeq,
    ...
    if (null == predicate) throw new RuntimeException("un registed predicate for "
  ...
  public static void filter(Collection entities, String category, String stdTypeIdSeq, String departIdSeq) {
    ...
    CollectionUtils.filter(entities,
  ...
  public static void filter(String predicateName, Collection entities, String stdTypeIdSeq, String departIdSeq) {
    if (null == entities || entities.isEmpty()) return;
    CollectionUtils.filter(entities, getPredicate(predicateName, stdTypeIdSeq, departIdSeq));
  }
   ...
   * @return
   */
  public static Collection select(String predicateName, Collection entities, String stdTypeIdSeq,
      String departIdSeq) {
    return CollectionUtils.select(entities, getPredicate(predicateName, stdTypeIdSeq, departIdSeq));
  }
   ...
   * @return
   */
  public static Collection select(Collection entities, String category, String stdTypeIdSeq,
      String departIdSeq) {
    return CollectionUtils.select(entities,
        getPredicate(category, entities.iterator().next(), stdTypeIdSeq, departIdSeq));
  }
