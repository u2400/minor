...
public class RequestUtil {
  ...
  public static Object populate(HttpServletRequest request, Class clazz, String name, boolean emptyIsNull) {
    Object obj = null;
    try {
  ...
  public static Object populate(HttpServletRequest request, Object object, String name, boolean emptyIsNull) {
    if (emptyIsNull) {
    ...
    try {
      ...
      while (type == null && StringUtils.isNotEmpty(parentAttr)) {
        try {
          ...
          if (null == type) { throw new RuntimeException("illegal property :" + attr); }
          if (type.isInterface()) {
