...
public interface GradeService {
   ...
   * @return
   */
  public void getGradeCourseMap(final ElectState state);
   ...
   * @return
   */
  public List getCourseGrades(final Long stdId, final MajorType majorType, final Boolean published,
   ...
   * @return
   */
  public List getCourseGrades(final TeachCalendar calendar, final Collection stds, final MajorType majorType,
   ...
   * @param isPublished
   */
  public void publishGrade(final String taskIds, final GradeType gradeType, final Boolean isPublished);
   ...
   * @return
   */
  public List getGradeRank(final String courseSeq, final String courseName, final String yearfrom,
      final String termfrom, final String yearto, final String termto, final String searchType,
      final Long departmentId);

  /**
   * 根据查询条件查询非正常考试成绩
   */
  public Collection getWithExamStatus(final String courseSeq, final String courseName, final String yearfrom,
      final String termfrom, final String yearto, final String termto, final String searchType,
      Long departmentId, final HttpServletRequest request);
