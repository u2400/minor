...
public interface CreditConstraintService {
   ...
   * @return
   */
  public Collection getStdCreditConstraints(List conditions, DataRealmLimit limit, List orderList);
   ...
   * @param observer
   */
  public void initCreditConstraint(String stdTypeIds, String departIds, TeachCalendar calendar,
   ...
   * @param observer
   */
  public void statStdCreditConstraint(StdCreditConstraint stdCreditConstraint, CreditInitParams params,
      OutputProcessObserver observer);
