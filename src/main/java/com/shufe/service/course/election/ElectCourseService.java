...
public interface ElectCourseService {
  ...
  public static String isNotInSchool = "error.elect.isNotInSchool";

  public static String overGenderLimit = "error.elect.overGenderLimit";

  public static String notMatchLanguageAbility = "error.elect.notMatchLanguageAbility";
