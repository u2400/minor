...
public class BookRequirementServiceImpl extends BasicService implements BookRequirementService {
  ...
  public Collection getBookRequirements(BookRequirement bookRequirement, PageLimit limit) {
    return bookRequirementDAO.getBookRequirements(bookRequirement, limit);

  }

  public List getBookRequirements(TeachCalendar calendar, AdminClass adminClass) {
    ...
    query.add(new Condition("adminClass.id=:adminClassId", adminClass.getId()));
