...
public interface BookRequireStatService {
   ...
   * @return
   */
  List statRequireBy(TeachCalendar calendar, DataRealm realm, String attr, Class clazz);
   ...
   * @return
   */
  List statCheckBy(TeachCalendar calendar, DataRealm realm, String attr, Class clazz);
}
