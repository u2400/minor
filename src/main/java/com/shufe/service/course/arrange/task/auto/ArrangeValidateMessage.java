...
public class ArrangeValidateMessage implements Serializable {
  ...
  public ArrangeValidateMessage(Serializable id, String info, String key, String message) {
    this.id = id;
    this.info = info;
    this.key = key;
  ...
  public ArrangeValidateMessage(Serializable id, String info, String key, String message, boolean resourse) {
    this.id = id;
    this.info = info;
    this.key = key;
    this.message = message;
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("id", this.id)
        .append("key", this.key).append("info", this.info).append("message", this.message).toString();
  }
