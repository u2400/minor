 ...
 * @author chaostone
 */
public class TaskWithRegularWeekUnitsPredicate implements Predicate, EvaluateValueRemember {
  ...
  public boolean evaluate(Object arg0) {
    ...
    if (null == weekUnits || null == units) return false;
    else return weekUnits.floatValue() % units.intValue() == 0;
  }
  ...
  public Object getEvaluateValue(Object obj) {
    ...
    Float weekUnits = task.getArrangeInfo().getWeekUnits();
    Integer units = task.getArrangeInfo().getCourseUnits();
    return (null == weekUnits) ? "" : weekUnits.toString() + "," + ((null == units) ? "" : units.toString());
  }
