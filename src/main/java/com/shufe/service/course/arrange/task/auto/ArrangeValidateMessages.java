...
public class ArrangeValidateMessages implements Serializable {
  ...
  private static final Comparator validateItemComparator = new Comparator() {
    public int compare(Object o1, Object o2) {
      return ((ArrangeValidateMessageItem) o1).getOrder() - ((ArrangeValidateMessageItem) o2).getOrder();
    }
  };
  ...
  /**
   * <p>
   * The accumulated set of <code>ArrangeValidateMessage</code> objects (represented as an
   * ArrayList) for each property, keyed by property name.
   * </p>
   */
  ...
  /**
   * <p>
   * The current number of the property/key being added. This is used to maintain the order messages
   * are added.
   * </p>
   */
  ...
  /**
   * <p>
   * Add a message to the set of messages for the specified property. An order of the property/key
   * is maintained based on the initial addition of the property/key.
   * </p>
   * 
   * @param property
  ...
  public void add(String property, ArrangeValidateMessage message) {
    ...
    ArrangeValidateMessageItem item = (ArrangeValidateMessageItem) messages.get(property);
    List list = null;
  ...
  /**
   * <p>
   * Adds the messages from the given <code>ArrangeValidateMessages</code> object to this set of
   * messages. The messages are added in the order they are returned from the
   * <code>properties</code> method. If a message's property is already in the current
   * <code>ArrangeValidateMessages</code> object, it is added to the end of the list for that
   * property. If a message's property is not in the current list it is added to the end of the
   * properties.
   * </p>
   * 
   * @param messages
  ...
  public void add(ArrangeValidateMessages messages) {
    ...
    while (props.hasNext()) {
      ...
      while (msgs.hasNext()) {
        ArrangeValidateMessage msg = (ArrangeValidateMessage) msgs.next();
  ...
  /**
   * <p>
   * Return the set of messages related to a specific property. If there are no such messages, an
  ...
  /**
   * <p>
   * Return the set of all recorded messages, without distinction by which property the messages are
   * associated with. If there are no messages recorded, an empty enumeration is returned.
   * </p>
   */
  public Iterator get() {
    if (messages.isEmpty()) { return Collections.EMPTY_LIST.iterator(); }
    ...
    for (Iterator i = actionItems.iterator(); i.hasNext();) {
      ArrangeValidateMessageItem ami = (ArrangeValidateMessageItem) i.next();
  ...
  /**
   * <p>
   * Return the set of property names for which at least one message has been recorded. If there are
   * no messages, an empty <code>Iterator</code> is returned. If you have recorded global messages,
   * the <code>String</code> value of <code>ArrangeMessages.TASK</code> will be one of the returned
   * property names.
   * </p>
   */
   ...
   * <strong>NOTE</strong> - it is more efficient to call <code>isEmpty</code> if all you care about
   * is whether or not there are any messages at all.
   * </p>
   */
  public int size() {
    int total = 0;
  ...
  /**
   * <p>
   * Return <code>true</code> if there are no messages recorded in this collection, or
  ...
  /**
   * <p>
   * This class is used to store a set of messages associated with a property/key and the position
   * it was initially added to list.
   * </p>
   */
