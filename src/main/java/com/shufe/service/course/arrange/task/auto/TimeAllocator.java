...
public interface TimeAllocator {
   ...
   * It records use history of every allocation.the return value <code>AvailableTime</code><br>
   ...
   * and params.getDensity() which represent in how many units we arrange one <code>Activity</code><br>
