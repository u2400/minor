...
public class ExamTeachTaskComparator implements Comparator {
  ...
  public int compare(Object arg0, Object arg1) {
    ...
    return new CompareToBuilder()
        .append(task0.getArrangeInfo().getTeacherNames(), task1.getArrangeInfo().getTeacherNames())
        .append(task0.getTeachClass().getStdCount(), task1.getTeachClass().getStdCount()).toComparison();
