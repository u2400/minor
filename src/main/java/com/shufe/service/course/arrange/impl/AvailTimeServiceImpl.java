 ...
 */
public class AvailTimeServiceImpl implements AvailTimeService {
  ...
  public AvailableTime getRoomAvailTime(Long roomId) {
    return (null != roomId) ? availTimeDAO.getRoomAvailTime(roomId) : null;
  ...
  public AvailableTime getTeacherAvailTime(Long teacherId) {
    return (null != teacherId) ? availTimeDAO.getTeacherAvailTime(teacherId) : null;
  }
  ...
  /**
   * @see com.shufe.service.course.arrange.AvailTimeService#saveTeacherAvailTime(com.shufe.model.system.baseinfo.Teacher,
   *      com.shufe.model.course.arrange.AvailableTime)
   */
