...
public class ExamTime implements Comparable {
  ...
  public int compareTo(Object object) {
    ...
    return new CompareToBuilder().append(getStartWeek(), myClass.getStartWeek())
        .append(getPriority(), myClass.getPriority()).append(getTurn(), myClass.getTurn())
        .append(getWeek().getId(), myClass.getWeek().getId()).toComparison();
  }
