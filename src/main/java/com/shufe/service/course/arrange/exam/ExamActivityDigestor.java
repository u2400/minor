...
public class ExamActivityDigestor {
  ...
  public static String digest(TeachCalendar calendar, Collection activities, MessageResources resourses,
      Locale locale) {
  ...
  public static String digest(TeachCalendar calendar, Collection activities, MessageResources resourses,
    ...
    for (Iterator iter = mergedActivities.iterator(); iter.hasNext();) {
      ...
      if (-1 != replaceStart) {
        arrangeInfoBuf.replace(replaceStart, replaceStart + date.length(), df.format(activity.getDate()));
      }
      ...
      if (-1 != replaceStart) {
        ...
        arrangeInfoBuf.replace(replaceStart, replaceStart + weeks.length(), TimeUnitUtil.digest(activity
            .getTime().getValidWeeks(), calendar.getWeekStart().intValue(), 1, TeachCalendar.OVERALLWEEKS,
