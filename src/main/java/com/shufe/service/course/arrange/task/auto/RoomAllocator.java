...
public interface RoomAllocator {
   ...
   * @return
   */
  public Classroom alloc(TimeUnit time, Collection rooms, Classroom room, boolean considerAvailTime);
   ...
   */
  public Classroom allocIgnoreOccupy(TimeUnit time, Collection rooms, Classroom room,
   ...
   * @return
   */
  public Classroom[] alloc(TimeUnit[] times, Collection rooms, Classroom example, boolean considerAvailTime);
   ...
   *         2) all room in roomScope is not avaliable in given time
   */
  public Classroom[] allocIgnoreOccupy(TimeUnit[] times, Collection rooms, Classroom example,
      boolean considerAvailTime);
