...
public class BeanPredicateWrapper extends BeanPredicate implements EvaluateValueRemember {
  ...
  public Object getEvaluateValue(Object obj) {
    try {
      Object value = PropertyUtils.getProperty(obj, this.getPropertyName());
