...
public interface TaskGroupService {
   ...
   *          1) id accurate select without any string matchmode,null will be ommited.<br>
   ...
   * @return
   */
  public Pagination getTaskGroups(TaskGroup group, Long[] stdTypes, Long[] teachDepartIds,
      TeachCalendar calendar, int pageNo, int pageSize, Boolean isCompleted);

  public Pagination getTaskGroups(TaskGroup group, Long[] stdTypes, Long[] teachDepartIds, String courseName,
      TeachCalendar calendar, int pageNo, int pageSize, Boolean isCompleted);
   ...
   * @return
   */
  public Pagination getTaskGroups(TaskGroup group, String stdTypeIdSeq, String teachDepartIdSeq,
      TeachCalendar calendar, int pageNo, int pageSize, Boolean isCompleted);
