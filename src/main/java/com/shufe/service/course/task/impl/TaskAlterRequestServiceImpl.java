...
public class TaskAlterRequestServiceImpl extends BasicService implements TaskAlterReqestService {
   ...
   * （非 Javadoc）
   * @see
   * com.shufe.service.course.TaskAlterRequestService#setTaskAlterRequestDAO(com.shufe.dao.course
   * .TaskAlterRequestDAO)
   */
   ...
   * （非 Javadoc）
   * @see
   * com.shufe.service.course.TaskAlterRequestService#saveTaskAlterRequest(com.shufe.model.course
   * .TaskAlterRequest)
   */
