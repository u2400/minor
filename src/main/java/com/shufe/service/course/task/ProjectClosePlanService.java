 ...
 */
public interface ProjectClosePlanService {
   ...
   * @return
   */
  public TeachTask getTeachTaskByStd(final String stdNo, final Long teachTaskId, final TeachCalendar calendar);
   ...
   * @return
   */
  public List getTeachTasksByCategory(final Serializable id, final TeachTaskFilterCategory category,
   ...
   * @return
   */
  public Pagination getTeachTasksByCategory(final Serializable id, final TeachTaskFilterCategory category,
      final TeachCalendar calendar, final int pageNo, final int pageSize);
