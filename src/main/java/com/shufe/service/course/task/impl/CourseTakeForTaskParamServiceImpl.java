...
public class CourseTakeForTaskParamServiceImpl extends BasicService implements CourseTakeForTaskParamService {
  ...
  public CourseTakeForTaskParam getCourseTakeForTaskParam(Serializable id) {
    return (CourseTakeForTaskParam) courseTakeForTaskParamDao.load(CourseTakeForTaskParam.class, id);
  }

  public List getCourseTakeForTaskParam(Long calendarId) {
    if (null != calendarId) {
      EntityQuery entityQuery = new EntityQuery(CourseTakeForTaskParam.class, "courseTakeForTaskParam");
