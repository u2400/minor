...
public interface QuestionnaireRecycleRateService {
   ...
   * @return
   */
  public List getTotleEvaluateAmount(String collegeIds, Collection teachCalendarId, String studentTypId);
   ...
   * @return
   */
  public List getTotleNumber(String collegeId, String studentTypeId, Collection teachCalendars);
