...
public class QuestionnaireRecycleRateServiceImpl extends BasicService implements
   ...
   */
  public void setQuestionnaireRecycleRateDAO(QuestionnaireRecycleRateDAO questionnaireRecycleRateDAO) {
   ...
   * （非 Javadoc）
   * @see
   * com.shufe.service.evaluate.QuestionnaireRecycleRateService#getTotlePersonAmount(java.lang.String
   * , com.shufe.model.system.calendar.TeachCalendar, java.lang.String)
   */
   ...
   * （非 Javadoc）
   * @see
   * com.shufe.service.evaluate.QuestionnaireRecycleRateService#getHasEvlautaeAmount(java.lang.String
   * , java.lang.String)
   */
  public List getHasEvlautaeDatas(String collegeIdSeq, String studentTypeIdSeq, Collection teachCalendars) {
    return questionnaireRecycleRateDAO.getHasEvlautaeData(collegeIdSeq, studentTypeIdSeq, teachCalendars);
  }

  /**
   * @see com.shufe.service.evaluate.QuestionnaireRecycleRateService#getResultNumbers(java.lang.String,
  ...
  /**
   * @see com.shufe.service.evaluate.QuestionnaireRecycleRateService#getTotleNumber(java.lang.String,
   *      java.lang.String)
   */
  ...
  /**
   * @see com.shufe.service.evaluate.QuestionnaireRecycleRateService#getRecycleRateObject(java.lang.String,
  ...
  public List getCurrentTeachCalendarList(String studentTypeIds) {
    ...
    for (Iterator iter = teachCalendars.iterator(); iter.hasNext();) {
      ...
      if (studentTypeIds.indexOf("," + teachCalendar.getStudentType().getId() + ",") != -1) {
  ...
  /**
   * @see com.shufe.service.evaluate.QuestionnaireRecycleRateService#getAllRateByCourseTask(java.lang.String,
   *      java.lang.String, java.util.Collection)
   */
  public List getAllRateByCourseTask(String departmentIds, String studentTypeIds, Collection teachCalendarSet) {
    return questionnaireRecycleRateDAO
        .getAllRateByCourseTask(departmentIds, studentTypeIds, teachCalendarSet);
  }

  /**
   * @see com.shufe.service.evaluate.QuestionnaireRecycleRateService#getDetailInfoOfTask(java.lang.String,
  ...
  public List getDetailInfoOfTask(String departmentIds, String departmentId, String studentTypeIds,
    ...
    return questionnaireRecycleRateDAO.getDetailInfoOfTask(departmentIds, departmentId, studentTypeIds,
        teachCalendarSet, studentOrTeacher);
  }
}
