...
public class CreditAuditInfo {
  ...
  public Boolean getIsPass() {
    if (requiredNum > 0) {
      return (completedNum >= requiredNum);
    } else {
      return Boolean.valueOf(((null == required) ? 0 : required.floatValue()) <= (((null == completed) ? 0
          : completed.floatValue()) + ((null == converted) ? 0 : converted.floatValue())));
    }
  }
  ...
  public final void setRequiredNum(int requiredNum) {
  ...
  public final void setCompletedNum(int completedNum) {
