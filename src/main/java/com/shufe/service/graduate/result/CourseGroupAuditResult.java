...
public class CourseGroupAuditResult {
  ...
  public CourseGroupAuditResult(CourseGroup group, List termList) {
    ...
    if (Boolean.TRUE.equals(group.getCourseType().getIsCompulsory())) {
      if (null == termList || termList.isEmpty()) {
        this.getCreditAuditInfo().setRequiredNum(group.getPlanCourses().size());
      } else {
        this.getCreditAuditInfo().setRequiredNum(group.getPlanCourses(termList).size());
      }
    }
  }
  ...
  public boolean equals(Object object) {
    if (!(object instanceof CourseGroupAuditResult)) { return false; }
