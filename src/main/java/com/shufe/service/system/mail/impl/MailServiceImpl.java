...
public class MailServiceImpl implements MailService {
   ...
   */
  public boolean sendSimpleMail(String title, String body, String to) throws MailSendException {
    boolean flag = true;
   ...
   *      java.lang.String, java.lang.String)
   */
  public void sendMimeMail(String title, String body, String to) throws MessagingException {
    ...
    message.setDataHandler(new javax.activation.DataHandler(new StringDataSource(body, "text/html")));
    mailSender.send(message);
  }
