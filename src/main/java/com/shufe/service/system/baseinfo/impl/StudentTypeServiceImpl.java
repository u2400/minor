...
public class StudentTypeServiceImpl extends
    com.ekingstar.eams.system.baseinfo.service.impl.StudentTypeServiceImpl implements StudentTypeService {

  public String getStdTypeIdSeqUnder(Long parenetId) {
    StudentType stdType = (StudentType) utilService.get(StudentType.class, parenetId);
