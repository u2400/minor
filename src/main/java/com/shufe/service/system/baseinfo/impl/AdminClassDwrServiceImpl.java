...
public class AdminClassDwrServiceImpl extends BasicService {
   ...
   * @return
   */
  public List getAdminClasses(String enrollYear, Long stdTypeId, Long departmentId, Long specialityId,
      Long aspectId) {
   ...
   * @return
   */
  public List getAdminClassNames(String enrollTurn, Long stdTypeId, Long departId, Long specialityId,
      Long aspectId) {
