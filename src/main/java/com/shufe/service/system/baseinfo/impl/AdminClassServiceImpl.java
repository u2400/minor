...
public class AdminClassServiceImpl extends BasicService implements AdminClassService {
  ...
  public AdminClass getAdminClass(String code) {
    ...
    else return (AdminClass) rs.get(0);
  }
   ...
   */
  public Pagination getAdminClasses(AdminClass adminClass, String stdTypeIdSeq, String departIdSeq,
      int pageNo, int pageSize) {
    return adminClassDAO.getAdminClasses(adminClass, SeqStringUtil.transformToLong(stdTypeIdSeq),
  ...
  public List getAdminClasses(AdminClass adminClass, String stdTypeIdSeq, String departIdSeq) {
    if (StringUtils.isNotEmpty(departIdSeq) && StringUtils.isNotEmpty(stdTypeIdSeq)) return adminClassDAO
        .getAdminClasses(adminClass, SeqStringUtil.transformToLong(stdTypeIdSeq),
  ...
  public List getAdminClassesExactly(AdminClass adminClass) {
    if (ValidEntityPredicate.INSTANCE.evaluate(adminClass.getDepartment())) return Collections.EMPTY_LIST;
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.system.baseinfo.AdminClassService#getAdminClassIdsByAdminClass(com.shufe.
   * model.system.baseinfo.AdminClass,
