...
public class TransferConvertListener implements CSVTransferListener {
  ...
  public void tranferField(String field, String value) throws Exception {
    Class type = PropertyUtils.getPropertyType(CSVDataTransfer.getCurTransfered(), field);
    PropertyUtils.setProperty(CSVDataTransfer.getCurTransfered(), field, ConvertUtils.convert(value, type));
  }
