...
public class FloatSegment implements Comparable {
  ...
  public int compareTo(Object object) {
    ...
    return new CompareToBuilder().append(myClass.getMin(), this.getMin()).toComparison();
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("min", this.getMin())
        .append("max", this.getMax()).append("count", this.count).toString();
  }
