...
public class TeachWorkloadStatServiceImpl extends BasicService implements TeachWorkloadStatService {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.workload.TeachWorkloadStatService#getAllSdtTypeContainSelf(java.lang.String)
   */
  public String getAllSdtTypeContainSelf(String studentTypeIds, String dataRealIdSeq) {
    if (StringUtils.isBlank(studentTypeIds)) { return "0"; }
    List stdTypeList = utilService.load(StudentType.class, "id",
   ...
   * (non-Javadoc)
   */
  public Map getTeacherNumberByConditions(String departIdSeq, String stdTypeIdSeq, Long teacherTypeId,
      TeachCalendar teachCalendar) {
    List tempList = teachWorkloadStatDAO.getTeacherNumberByConditions(departIdSeq, stdTypeIdSeq,
  ...
  /**
     * 
     */
  public Map getTotalWorkloadByConditions(String deparIdSeq, String stdTypeIdSeq, Long teacherTypeId,
      TeachCalendar teachCalendar) {
  ...
  /*
   * (non-Javadoc)
   * @see com.shufe.service.workload.TeachWorkloadStatService#
   * getHunmanNumberAndTotleWorkloadByCalendarAndStudentType
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.workload.TeachWorkloadStatService#getPeopleOfDepartment(com.shufe.model.system
  ...
  public List getPeopleOfDepartment(TeachCalendar teachCalendar, String studentTypeIds, String departmentIds) {
    return teachWorkloadStatDAO.getPeopleOfDepartment(teachCalendar, studentTypeIds, departmentIds);
  }

  /*
   * (non-Javadoc)
   * @see
   * com.shufe.service.workload.TeachWorkloadStatService#getCourseNumberOfDepartment(com.shufe.model
   * .system.calendar.TeachCalendar,
   * java.lang.String, java.lang.String, java.lang.String)
   */
  public Map getCourseTypesOfDepartment(TeachCalendar teachCalendar, String stdTypeIdSeq, String collegeIdSeq) {
    List courseTypesList = teachWorkloadStatDAO.getCourseNumberOfDepartment(teachCalendar, stdTypeIdSeq,
        collegeIdSeq);
    ...
    for (Iterator iter = courseTypesList.iterator(); iter.hasNext();) {
      ...
      if (null == courseType) {
        ...
        StatUtils.setValueToMap("0-" + courseType.getId(), element[0], "integer", couseTypeDepartMap);
      }
      StatUtils.setValueToMap(department.getId() + "-0", element[0], "integer", couseTypeDepartMap);
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.workload.TeachWorkloadStatService#getRateOfTitleAndStdType(com.shufe.model
   * .system.calendar.TeachCalendar,
   * java.lang.String, java.lang.String)
   */
  public Map getTitleAndStdTypesNo(TeachCalendar teachCalendar, String departIdSeq, String stdIdSeq) {
    List tempList = teachWorkloadStatDAO.getTitleAndStdTypes(teachCalendar, departIdSeq, stdIdSeq);
    Map m = new HashMap();
    for (Iterator iter = tempList.iterator(); iter.hasNext();) {
      Object[] element = (Object[]) iter.next();
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.workload.TeachWorkloadStatService#getWorkloadByStdTypeAndTeacherType(com.
   * shufe.model.system.calendar.TeachCalendar,
   * java.lang.String, java.util.List, java.util.List)
   */
  public Map getWorkloadByDepartAndTeacherType(TeachCalendar teachCalendar, String studentTypeIds,
      String departmentIdSeq, Boolean isCaculate) {
    List tempList = teachWorkloadStatDAO.getWorkloadOfTeacherTypeAndDepart(teachCalendar, studentTypeIds,
        departmentIdSeq, isCaculate);
    ...
    for (Iterator iter = tempList.iterator(); iter.hasNext();) {
      ...
      if (null == teacherType) {
        ...
        StatUtils.setValueToMap("0-" + teacherType.getId(), element[0], "float", requiredMap);
      }
   ...
   */
  public Map getWorkloadByDataRealm(String departIdSeq, String stdTypeIdSeq, TeachCalendar teachCalendar) {
    List tempList = teachWorkloadStatDAO.getWorkloadByDataRealm(departIdSeq, stdTypeIdSeq, teachCalendar);
   ...
   */
  public Map getWorkloadByDataRealm(String departIdSeq, String stdTypeIdSeq, Collection teachCalendars) {
    List tempList = teachWorkloadStatDAO.getWorkloadByDataRealm(departIdSeq, stdTypeIdSeq, teachCalendars);
  ...
  public Map getWorkloadByTeacherAndCalendar(String departIdSeq, String stdTypeIdSeq,
    ...
    List tempList = teachWorkloadStatDAO.getWorkloadOfTeacherAndCalendar(departIdSeq, stdTypeIdSeq,
        teachCalendars);
    Map returnMap = new HashMap();
   ...
   */
  public Map getEduDegreeAndTitle(String departmentIds, String propertyName, Long calendarId, Integer age,
      String stdTypeIdSeq) {
    List tempList = teachWorkloadStatDAO.getEduDegreeAndTitle(departmentIds, propertyName, calendarId, age,
        stdTypeIdSeq);
    Map m = new HashMap();
    for (Iterator iter = tempList.iterator(); iter.hasNext();) {
      Object[] element = (Object[]) iter.next();
  ...
  public Map getEduDegreeAndTitleInTeacher(String propertyName, String departmentIds, Integer age) {
    List list = teachWorkloadStatDAO.getEduDegreeAndTitleInTeacher(propertyName, departmentIds, age);
    Map m = new HashMap();
  ...
  /**
   * @see com.shufe.service.workload.course.TeachWorkloadStatService#getAvgCourseNo(String, String,
   *      TeachCalendar)
   */
  public List getAvgCourseNo(String departmentIdSeq, String stdTypeIdSeq, TeachCalendar teachCalendar) {
    return teachWorkloadStatDAO.getAvgCourseNoOfWokload(departmentIdSeq, stdTypeIdSeq, teachCalendar);
  }
  ...
  public List getPropertyOfTeachWorkload(String propertyOfTeachWorkload, Long teachCalendarId) {
    return teachWorkloadStatDAO.getPropertyOfTeachWorkload(propertyOfTeachWorkload, teachCalendarId);
  }
