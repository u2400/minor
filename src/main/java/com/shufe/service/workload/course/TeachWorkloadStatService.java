...
public interface TeachWorkloadStatService {
   ...
   * @return
   */
  public List getPeopleOfDepartment(TeachCalendar teachCalendar, String studentTypeIds, String departmentId);
   ...
   * @return
   */
  public Map getEduDegreeAndTitle(String departmentId, String propertyName, Long calendarId, Integer age,
      String stdTypeIdSeq);
