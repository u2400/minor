...
public interface InstructWorkloadService {
   ...
   */
  public abstract InstructModulus getInstructModulus(Long studentTypeId, Long departmentId);
   ...
   * int, int)
   */
  public abstract Pagination findStatisticObjects(Criteria criteria, int pageNo, int pageSize);
   ...
   */
  public abstract Criteria getStatisticsObjects(InstructWorkload instructWorkload, String departmentIds,
   ...
   * @param calendarId
   */
  public void statWorkload(TeachCalendar calendar, DataRealm realm, String modulusType);
