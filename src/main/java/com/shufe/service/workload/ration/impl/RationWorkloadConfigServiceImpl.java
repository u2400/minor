...
public class RationWorkloadConfigServiceImpl extends BasicService implements RationWorkloadConfigService {

  private RationWorkloadConfigDAO rationWorkloadConfigDAO;

  public void setRationWorkloadConfigDAO(RationWorkloadConfigDAO rationWorkloadConfigDAO) {
  ...
  public Pagination getTeacherPagi(Criteria criteria, int pageNo, int pageSize) {
    // TODO Auto-generated method stub
    return rationWorkloadConfigDAO.dynaSearch(criteria, pageNo, pageSize);
  }
}
