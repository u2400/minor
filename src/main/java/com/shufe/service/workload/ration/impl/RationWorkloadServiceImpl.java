...
public class RationWorkloadServiceImpl extends BasicService implements RationWorkloadService {
  ...
  /*
   * (non-Javadoc)
   * @see com.shufe.service.rationWorkload.RationWorkloadService#findRations(org.hibernate.Criteria,
   * int, int)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.rationWorkload.RationWorkloadService#getRationWorkloads(java.lang.String)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.rationWorkload.RationWorkloadService#getRationWorkloadList(java.lang.String)
   */
