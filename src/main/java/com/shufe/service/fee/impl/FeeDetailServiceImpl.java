...
public class FeeDetailServiceImpl extends BasicService implements FeeDetailService {
  ...
  public List getFeeDetails(FeeDetail feeDetail) {
    if (null == feeDetail) return Collections.EMPTY_LIST;
    else return feeDetailDAO.getFeeDetails(feeDetail);
  }
   ...
   */
  public Pagination getFeeDetailsOfTypes(FeeDetail feeDetail, List feeTypeList, String orderByName,
      int pageNo, int pageSize) {
    return feeDetailDAO.getFeeDetailOfTypes(feeDetail, feeTypeList, orderByName, pageNo, pageSize);
  }
