...
public class StudentGenderCount {
  ...
  public void add(StudentGenderCount studentGenderCount) {
    maleCount = new Integer((maleCount == null ? 0 : maleCount.intValue())
        + (studentGenderCount.getMaleCount() == null ? 0 : studentGenderCount.getMaleCount().intValue()));
    femaleCount = new Integer((femaleCount == null ? 0 : femaleCount.intValue())
        + (studentGenderCount.getFemaleCount() == null ? 0 : studentGenderCount.getFemaleCount().intValue()));
    totalCount = new Integer((totalCount == null ? 0 : totalCount.intValue())
        + (studentGenderCount.getTotalCount() == null ? 0 : studentGenderCount.getTotalCount().intValue()));
  }

  public StudentGenderCount(Integer maleCount, Integer femaleCount, Integer otherCount) {
    this.maleCount = maleCount;
    this.femaleCount = femaleCount;
    if (NotZeroNumberPredicate.getInstance().evaluate(otherCount)) {
      this.totalCount = new Integer(maleCount.intValue() + femaleCount.intValue() + otherCount.intValue());
    } else {
      this.totalCount = new Integer(maleCount.intValue() + femaleCount.intValue());
    }
  }
  ...
  public Integer add(Integer a, Number b) {
    if (a == null) {
      if (b == null) return new Integer(0);
      else {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("totalCount", this.totalCount)
        .append("maleCount", this.maleCount).append("femaleCount", this.femaleCount).toString();
  }
