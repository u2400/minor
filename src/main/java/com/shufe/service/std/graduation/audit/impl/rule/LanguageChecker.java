...
public class LanguageChecker implements RuleExecutor {
  ...
  public boolean execute(Context context) {
    ...
    List languageGradeList = utilService.load(OtherExamCategory.class, "id",
        SeqStringUtil.transformToLong(languageGrades));
    ...
    if (null != languageGrades && !"".equals(languageGrades)) {
      ...
      for (Iterator iter = languageGradeList.iterator(); iter.hasNext();) {
        ...
        info.setDescription(StringUtils.defaultIfEmpty(info.getDescription(), "") + examCategory.getName());
