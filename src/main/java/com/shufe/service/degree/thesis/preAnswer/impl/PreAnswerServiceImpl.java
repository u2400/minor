...
public class PreAnswerServiceImpl extends BasicService implements PreAnswerService {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.thesis.answer.AnswerService#getPropertyList(com.shufe.model.thesis.answer
   * .PreAnswer,
  ...
  public Pagination getPaginationOfNoApply(ThesisManage thesisManage, String departIdSeq,
    ...
    return preAnswerDAO.getPaginationOfNoApply(thesisManage, departIdSeq, stdTypeIdSeq, pageNo, pageSize);
  }
  ...
  public PreAnswer getLastPreAnswer(Student student) {
    ...
    List stdPreAnswers = preAnswerDAO.getPreAnswers(preAnswer, student.getDepartment().getId().toString(),
        student.getType().getId().toString());
