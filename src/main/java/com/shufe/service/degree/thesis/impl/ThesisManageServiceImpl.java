...
public class ThesisManageServiceImpl extends BasicService implements ThesisManageService {
  ...
  public ThesisManage getThesisManage(Long studentId) {
    List thesisManageList = utilService.load(ThesisManage.class, new String[] { "student.id", "majorType" },
        new Object[] { studentId, new MajorType(MajorType.FIRST) });
    return thesisManageList.size() > 0 ? (ThesisManage) thesisManageList.get(0) : null;
  }

  /**
   * 分页对象.
   * 
   * @see com.shufe.service.degree.thesis.ThesisManageService#getThesisManagePagis(com.shufe.model.degree.thesis.ThesisManage,
   *      int, int)
   */
  public Pagination getThesisPagis(ThesisManage thesisManage, String departmentSeq, String stdTypeSeq,
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.thesis.ThesisManageService#getThesisManagesNotNull(com.shufe.model.thesis
   * .ThesisManage, java.lang.String, java.lang.String, java.lang.String)
   */
  public List getThesissNullNotNull(ThesisManage thesisManage, String deparmentSeq, String stdTypeSeq,
   ...
   */
  public Pagination getThesissPaginaByNullNotNull(ThesisManage thesisManage, String deparmentSeq,
      String stdTypeSeq, int pageNo, int pageSize, String notNulls, String nulls, String orderString) {
    return thesisManageDAO.getThesisManagePaginaForNotNull(thesisManage, deparmentSeq, stdTypeSeq, pageNo,
        pageSize, notNulls, nulls, orderString);
  }

  /**
   * @see com.shufe.service.degree.thesis.ThesisManageService#getThesisTopicOpenIds(com.shufe.model.degree.thesis.ThesisManage,
