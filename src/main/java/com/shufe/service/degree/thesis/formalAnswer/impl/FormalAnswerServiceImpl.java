...
public class FormalAnswerServiceImpl extends BasicService implements FormalAnswerService {
   ...
   */
  public List getFormalAnswers(FormalAnswer formalAnswer, String departmentIdSeq, String stdTypeIdSeq) {
    return formalAnswerDAO.getFormalAnswers(formalAnswer, departmentIdSeq, stdTypeIdSeq);
  }

  /*
   * (non-Javadoc)
   * @see
   * com.shufe.service.thesis.formalAnswer.FormalAnswerService#getFormalAnswerPagination(com.shufe
   * .model.thesis.answer.FormalAnswer,
  ...
  public Pagination getFormalAnswerPagination(FormalAnswer formalAnswer, String departmentIdSeq,
    ...
    return formalAnswerDAO.getFormalAnswerPagination(formalAnswer, departmentIdSeq, stdTypeIdSeq, pageNo,
        pageSize);
  }

  /**
   * @see com.shufe.service.degree.thesis.formalAnswer.FormalAnswerService#batchUpdate(java.lang.String[],
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.thesis.formalAnswer.FormalAnswerService#getPropertys(com.shufe.model.thesis
   * .answer.FormalAnswer, java.lang.String, java.lang.String, java.lang.String)
   */
  public List getPropertys(FormalAnswer formalAnswer, String departmentIdSeq, String stdTypeIdSeq,
