...
public class ChooseTutorServiceImpl extends BasicService implements ChooseTutorService {
  ...
  public void setTutorByStd(Long stdId, Tutor tutor) {
    ...
    if (chooseTutor != null) {
      ...
      ChooseTutor ct = new ChooseTutor((Student) utilService.load(Student.class, stdId), tutor);
  ...
  public Pagination relationStdList(ChooseTutor ct, String studentTypeIds, String departmentIds, int pageNo,
      int pageSize) {
    return chooseTutorDAO.dynaSearch(
        chooseTutorDAO.constructStudentCriteria(ct, studentTypeIds, departmentIds, pageNo, pageSize), pageNo,
        pageSize);
  }
