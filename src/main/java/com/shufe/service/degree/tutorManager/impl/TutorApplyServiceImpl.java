...
public class TutorApplyServiceImpl extends BasicService implements TutorApplyService {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.degree.tutorManager.TutorApplyService#getTutorApplyList(com.shufe.model.degree
   * .tutorManager.tutor.TutorApply, java.lang.String)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.service.degree.tutorManager.TutorApplyService#getTutorApplyPagi(com.shufe.model.degree
   * .tutorManager.tutor.TutorApply, java.lang.String, int, int)
   */
