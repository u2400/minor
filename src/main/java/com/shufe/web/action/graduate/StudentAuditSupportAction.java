...
public class StudentAuditSupportAction extends StudentSearchAction {
   ...
   *          是否返回空对象结果
   */
  public void getStudentTeachPlanAuditDetail(Student student, MajorType majorType, Long auditStandardId,
      String auditTerm, Boolean isGradeDeploy, Boolean returnNullResult) {
    List resultList = graduateAuditService.getStudentTeachPlanAuditDetail(student, majorType,
        auditStandardId, graduateAuditService.getAuditTermList(auditTerm), isGradeDeploy, returnNullResult);
