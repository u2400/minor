...
public class PreAnswerStdAction extends RestrictionSupportAction {
   ...
   * @throws Exception
   */
  public ActionForward answer(ActionMapping mapping, ActionForm form, HttpServletRequest request,
   ...
   * @throws Throwable
   */
  public ActionForward affirmPreAnswer(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Throwable {
   ...
   * @return
   */
  public ActionForward previewPrint(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    request.setAttribute("student", student);
    if (StringUtils.isNotBlank(preAnswerNum) && preAnswerNum.indexOf(",") != -1) {
      ...
      PreAnswer preAnswer = preAnswerService.getPreAnswerByNum(student, Integer.valueOf(preAnswerNum));
      ...
      for (Iterator iter = answerTeamSet.iterator(); iter.hasNext();) {
        ...
        if (null != team.getIsChairMan() && team.getIsChairMan().booleanValue()) {
      ...
      request.setAttribute("topicOpen", preAnswer.getThesisManage().getTopicOpen());
