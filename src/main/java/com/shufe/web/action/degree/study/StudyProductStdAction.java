...
public class StudyProductStdAction extends StudyProductHelper {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    query
        .add(new Condition("studyProduct.student.id=" + getStudentFromSession(request.getSession()).getId()));
    addCollection(request, "studyProducts", utilService.search(query));
    return forward(request, "studyProductList");
  }

  public ActionForward saveAward(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.web.action.degree.study.StudyProductHelper#configExportContext(javax.servlet.http
   * .HttpServletRequest, com.ekingstar.commons.transfer.exporter.Context)
   */
