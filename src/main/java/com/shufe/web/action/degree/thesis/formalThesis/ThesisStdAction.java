...
public class ThesisStdAction extends ThesisDownloadAction {
  ...
  public ActionForward index(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == thesisManage || null == thesisManage.getTopicOpen()) { return forward(request,
        "noscheduleErrors"); }
   ...
   * @throws Exception
   */
  public ActionForward saveThesis(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
