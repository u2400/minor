...
public class StudyProductHelper extends RestrictionSupportAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == productId) {
      ...
      product = (StudyProduct) utilService.get(StudyProduct.getStudyProductType(productType), productId);
    }
    request.setAttribute("studyProduct", product);
    addCollection(request, "projectTypeList", baseCodeService.getCodes(ProjectType.class));
    addCollection(request, "literatureTypeList", baseCodeService.getCodes(LiteratureType.class));
    addCollection(request, "publicationLevelList", baseCodeService.getCodes(PublicationLevel.class));
    addCollection(request, "thesisIndexList", baseCodeService.getCodes(ThesisIndexType.class));
    addCollection(request, "meetingTypes", baseCodeService.getCodes(MeetingType.class));
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    String productType = request.getParameter("productType");
    Long productId = getLong(request, "studyProductId");
    StudyProduct product = (StudyProduct) utilService.get(StudyProduct.getStudyProductType(productType),
        productId);
    request.setAttribute("studyProduct", product);
  ...
  public ActionForward editAward(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  protected void configExportContext(HttpServletRequest request, Context context) {
    ...
    if ("statisStudyProducts".equals(excelType)) {
      ...
      context.put("resultMap", studyProductService.getStdPropertyOfProduct(valueMap,
          getDepartmentIdSeq(request), getStdTypeIdSeq(request)));
      context.put("publicTypes", utilService.load(PublicationLevel.class, "state", Boolean.TRUE));
      context.put("projectTypes", utilService.load(ProjectType.class, "state", Boolean.TRUE));
      context.put("literatureTypes", utilService.load(LiteratureType.class, "state", Boolean.TRUE));
  ...
  public void setExportDatas(HttpServletRequest request, Context context, Student student, Boolean isPassed) {
    Map studyResults = studyProductService.getStudyProducts(student.getId(), Boolean.TRUE, isPassed);
