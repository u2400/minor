...
public class TopicOpenTutorAction extends TopicOpenAction {
  ...
  public ActionForward doStdList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (Boolean.TRUE.equals(isOpen)) {
      ...
      Pagination studentPage = topicOpenService.getstdsNoOpened(student, null, null, getPageNo(request),
          getPageSize(request));
  ...
  public ActionForward researchValidate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    topicOpenService.batchUpdate(new String[] { "tutorAffirm" }, new Object[] { Boolean.valueOf(validate) },
        thesisManage.getTopicOpen().getId().toString());
