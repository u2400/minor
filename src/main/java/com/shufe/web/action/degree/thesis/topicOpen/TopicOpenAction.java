...
public class TopicOpenAction extends TopicOpenSearchAction {
  ...
  public ActionForward doStdList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (Boolean.TRUE.equals(isOpen)) {
      ...
      Pagination studentPage = topicOpenService.getstdsNoOpened(student, getDepartmentIdSeq(request),
          getStdTypeIdSeq(request), getPageNo(request), getPageSize(request));
   ...
   * @throws Exception
   */
  public ActionForward doLoadThesisTopic(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward researchValidate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String stdId = request.getParameter("stdId");
    ...
    topicOpenService.batchUpdate(new String[] { "departmentAffirm" },
        new Object[] { Boolean.valueOf(validate) }, thesisManage.getTopicOpen().getId().toString());
   ...
   * @throws Exception
   */
  public ActionForward thesisOperation(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String stdId = request.getParameter("stdId");
    Student student = studentService.getStudent(Long.valueOf(stdId));
    if (topicOpenService.checkDepartmentValidate(student)) { return doLoadThesisTopic(mapping, form, request,
        response); }
    ...
    if (thesisManages.size() > 0) {
      ...
      TopicOpen topicOpen = null != thesisManage ? thesisManage.getTopicOpen() : new TopicOpen();
  ...
  public ActionForward doSettinTimeAndAddress(ActionMapping mapping, ActionForm form,
    ...
    if ("select".equals(flag)) {
      ...
      ThesisManage thesisManage = (ThesisManage) populate(request, ThesisManage.class, "thesisManage");
   ...
   * @throws Exception
   */
  public ActionForward doUpdateIsPassed(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String estate = request.getParameter("isPassedValue");
    String topicOpenIdSeq = request.getParameter("topicOpenIdSeq");
    topicOpenService.batchUpdate(new String[] { "isPassed" }, new Object[] { Integer.valueOf(estate) },
        topicOpenIdSeq);
    return redirect(request, "doStdList", "info.action.success");
  }
   ...
   * @throws Exception
   */
  public ActionForward doModifyTopicOpen(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String affirm = request.getParameter("isAffirm");
    String personType = request.getParameter("personType");
    String topicOpenIdSeq = request.getParameter("topicOpenIdSeq");
    if (personType.indexOf("teacher") > -1) {
      topicOpenService.batchUpdate(new String[] { "tutorAffirm" }, new Object[] { Boolean.valueOf(affirm) },
          topicOpenIdSeq);
   ...
   * @throws Exception
   */
  public ActionForward cancelStdCommit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String topicOpenIdSeq = request.getParameter("topicOpenIdSeq");
    topicOpenService.batchUpdate(new String[] { "finishOn" }, new Object[] { null }, topicOpenIdSeq);
    return redirect(request, "doStdList", "info.action.success");
  }
