...
public class AppointStdAction extends RestrictionSupportAction {
   ...
   * @throws Exception
   */
  public ActionForward setStdtoTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward searchStd(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long tutorId = getLong(request, "tutorId");
    Tutor tutor = (Tutor) utilService.load(Tutor.class, tutorId);
    setDataRealm(request, hasStdTypeCollege);
   ...
   * @throws Exception
   */
  public ActionForward tutorStdList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    EntityQuery entityQuery = new EntityQuery(Student.class, "student");
    populateConditions(request, entityQuery);
    entityQuery.addOrder(OrderUtils.parser(request.getParameter("orderBy")));
   ...
   * @throws Exception
   */
  public ActionForward unSetStdtoTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String stdIds = request.getParameter("stdIds");
