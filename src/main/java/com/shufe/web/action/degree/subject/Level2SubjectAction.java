...
public class Level2SubjectAction extends RestrictionSupportAction {
  ...
  public ActionForward index(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    addOldPage(request, "level2Subjects", subjectService.getLevel2Subjects(
        (Level2Subject) populate(request, Level2Subject.class), getPageSize(request), getPageNo(request)));
    return forward(request);
  }

  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Level2Subject level2Subject = (Level2Subject) getEntity(request, Level2Subject.class, "level2Subject");
    ...
    if (!level2Subject.isPO()) {
      ...
      query.add(new Condition("not exists(from Level2Subject s where s.speciality.id=speciality.id)"));
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    try {
      if (!level2Subject.isPO()) {
        logHelper
            .info(request, "Create a level2Subject with name:" + level2Subject.getSpeciality().getName());
        utilService.saveOrUpdate(level2Subject);
      } else {
        logHelper
            .info(request, "Update a level2Subject with name:" + level2Subject.getSpeciality().getName());
      ...
      return forward(mapping, request, new String[] { "entity.level2Subject", "error.model.existed" },
          "error");
    } catch (Exception e) {
      logHelper.info(request, "Failure save or update a level2Subject with name:"
          + level2Subject.getSpeciality().getName(), e);
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(level2SubjectId)) return forward(mapping, request, new String[] {
        "entity.level2Subject", "error.model.id.needed" }, "error");
    Level2Subject level2Subject = (Level2Subject) utilService.get(Level2Subject.class, new Long(
        level2SubjectId));
   ...
   * @throws Exception
   */
  public ActionForward statByCollege(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
