...
public class TutorManagerAction extends RestrictionSupportAction {
   ...
   * @throws Exception
   */
  public ActionForward editDescription(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "teacher", getTeacherFromSession(request.getSession()));
  ...
  private void prepareEditData(HttpServletRequest request) {
    ...
    Results.addObject("doctorType", TutorType.DOCTOR_TUTOR).addObject("masterType", TutorType.MASTER_TUTOR);
  }
   ...
   * @throws Exception
   */
  public ActionForward saveOrUpdateTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward delTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ActionForward doTeacherList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ActionForward doDefault(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Results.addObject("departmentList", departmentList).addObject("doctorType", TutorType.DOCTOR_TUTOR)
        .addObject("masterType", TutorType.MASTER_TUTOR);
  ...
  public ActionForward doStdList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Pagination studentPage = OldPagination.buildOldPagination((SinglePage) utilService.search(query));
   ...
   * @throws Exception
   */
  public ActionForward doAddStdToTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    actionMessges.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("filed.gradeNod.addSuccess"));
   ...
   * @throws Exception
   */
  public ActionForward doDelStdFromTutor(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
