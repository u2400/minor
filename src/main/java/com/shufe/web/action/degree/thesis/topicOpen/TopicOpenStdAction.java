...
public class TopicOpenStdAction extends FileAction {
  ...
  public ActionForward doLoadThesisTopic(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == thesisManage || null == thesisManage.getSchedule()) {
      ...
      if (null == thesisManage) {
        ...
        thesisManage.setTeachCalendar(teachCalendarService.getNearestCalendar(student.getType()));
   ...
   * @throws Exception
   */
  public ActionForward topicOpenInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward editInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Student std = getStudentFromSession(request.getSession());
    String topicOpenFlag = request.getParameter("topicOpenFlag");
    request.setAttribute("topicOpen", topicOpenService.getTopicOpen(std.getId()));
    ...
    request.setAttribute("thesisTypes", utilService.load(ThesisType.class, "state", Boolean.TRUE));
    request.setAttribute("thesisSources", utilService.load(ThesisTopicSource.class, "state", Boolean.TRUE));
    return forward(request);
  }
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    return redirect(
        ...
        "topicOpenFlag=" + request.getParameter("topicOpenFlag") + "&stdType="
   ...
   * @throws Exception
   */
  public ActionForward doUpThesis(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public void doDownloadThesis(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long topicOpenId = getLong(request, "topicId");
    TopicOpen topicOpen = (TopicOpen) utilService.load(TopicOpen.class, topicOpenId);
    String fileAbsolutePath = getFileRealPath(FilePath.THESIS, request) + topicOpen.getDownloadName();
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.web.action.system.file.FileAction#afterUpload(javax.servlet.http.HttpServletRequest,
  ...
  protected void afterUpload(HttpServletRequest request, File file, String updloadFilePath) {
    ...
    TopicOpen topicOpen = (TopicOpen) utilService.load(TopicOpen.class, Long.valueOf(topicOpenId));
   ...
   * (non-Javadoc)
   * @see
   * com.shufe.web.action.system.file.FileAction#getFileName(javax.servlet.http.HttpServletRequest,
   * java.lang.String)
   */
   ...
   * @throws Exception
   */
  public ActionForward doAffirm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Student student = getStudentFromSession(request.getSession());
    ThesisManage thesisManage = thesisManageService.getThesisManage(student);
