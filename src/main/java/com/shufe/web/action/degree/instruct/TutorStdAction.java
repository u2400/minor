...
public class TutorStdAction extends DispatchBasicAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    query.add(new Condition("std.teacher.code = (:name)", getUser(request.getSession()).getName()));
  ...
  public ActionForward planFinished(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    try {
      List resultList = graduateAuditService.getStudentTeachPlanAuditDetail(student, null, null,
          graduateAuditService.getAuditTermList(request.getParameter("auditTerm")), new Boolean(true),
          Boolean.TRUE);
