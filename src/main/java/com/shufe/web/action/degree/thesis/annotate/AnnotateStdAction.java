...
public class AnnotateStdAction extends FileAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List thesiss = utilService.load(StudyThesis.class, new String[] { "student.id", "isPassCheck" },
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isNotEmpty(publicThesisSeq)) {
      publicThesiss = utilService.load(StudyThesis.class, "id",
          SeqStringUtil.transformToLong(publicThesisSeq));
    }
   ...
   * @throws Exception
   */
  public void doDownloadAnnotateDoc(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
