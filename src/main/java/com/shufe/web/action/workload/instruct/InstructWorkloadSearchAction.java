...
public class InstructWorkloadSearchAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    DataRealmUtils.addDataRealms(query, new String[] { "instructWorkload.studentType.id",
        "instructWorkload.teacherInfo.teachDepart.id" },
        getDataRealmsWith(getLong(request, "instructWorkload.studentType.id"), request));
   ...
   * @return
   */
  public ActionForward loadDetail(ActionMapping mapping, ActionForm form, HttpServletRequest request,
  ...
  protected Collection getExportDatas(HttpServletRequest request) {
    ...
    DataRealmUtils.addDataRealms(entityQuery, new String[] { "instructWorkload.studentType.id" },
