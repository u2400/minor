...
public class TeachWorkloadAction extends TeachWorkloadSearchAction {
  ...
  public ActionForward statistic(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Map resultMap = teachWorkloadService.statTeachWorkload(stdTypeIdSeq, departIdSeq, calendarIdSeq);
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(flag)) {
      request.setAttribute("departmentList", departmentService.getColleges(getDepartmentIdSeq(request)));
      return forward(request, "form");
    }
    String teachTaskId = get(request, "teachTeakId");
    TeachTask teachTask = (TeachTask) utilService.get(TeachTask.class, Long.valueOf(teachTaskId));
    ...
    TeachWorkload teachWorkload = teachWorkloadService.buildTeachWorkload(teacher, teachTask, categorys,
        teachModulus);
  ...
  public ActionForward taskList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Pagination pagination = teachTaskService.getTeachTasksOfTeachDepart(teachTask, getStdTypeIdSeq(request),
  ...
  public ActionForward updateForm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
    TeachWorkload teachWorkload = (TeachWorkload) utilService.get(TeachWorkload.class,
        getLong(request, "teachWorkloadId"));
    request.setAttribute("teachWorkload", teachWorkload);
    request.setAttribute("teachModulus",
        teachModulusService.getModulus(new TeachModulus(), getStdTypeIdSeq(request)));
    request.setAttribute("departmentList", departmentService.getDepartments(getDepartmentIdSeq(request)));
    return forward(request);
  }
  ...
  protected TeachWorkloadStatus buildWorkloadStatus(TeachWorkload teachWorkload, Boolean isAfter) {
    ...
    if (Boolean.TRUE.equals(isAfter)) {
      TeachModulus modulus = (TeachModulus) utilService.load(TeachModulus.class, teachWorkload
          .getTeachModulus().getId());
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    List teachWorkloads = utilService.load(TeachWorkload.class, "id",
        SeqStringUtil.transformToLong(get(request, "teachWorkloadIds")));
  ...
  public ActionForward addWorkloadNoTaskForm(ActionMapping mapping, ActionForm form,
    ...
    request.setAttribute("openColleges", departmentService.getDepartments(getDepartmentIdSeq(request)));
    request.setAttribute("teachModulus",
        teachModulusService.getModulus(new TeachModulus(), getStdTypeIdSeq(request)));
   ...
   * @throws Exception
   */
  public ActionForward saveWorkloadNoTask(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    teachWorkload.setTeachCalendar(teachCalendarService.getTeachCalendar(stdTypeId, year, term));
    // 添加课程种类
    Long teachModuluId = getLong(request, "teachWorkload.teachModulus.id");
    TeachModulus teachModulus = (TeachModulus) utilService.get(TeachModulus.class, teachModuluId);
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Transfer transfer = ImporterServletSupport.buildEntityImporter(request, TeachWorkload.class, tr);
    if (null == transfer) { return forward(request, "/pages/component/importData/error"); }
    ...
    transfer.addListener(new ImporterForeignerListener(utilService)).addListener(workloadListener);
