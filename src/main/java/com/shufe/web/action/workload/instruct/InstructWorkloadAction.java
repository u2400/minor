...
public class InstructWorkloadAction extends InstructWorkloadSearchAction {
  ...
  public ActionForward statistic(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    DataRealm realm = new DataRealm(request.getParameter("stdTypeIdSeq"), request.getParameter("departIdSeq"));
    User user = getUser(request.getSession());
    info(user.getName() + " removed  workload with stdTypeId:" + realm.getStudentTypeIdSeq() + "calendarId:"
        + calendar.getId());
   ...
   * @return
   */
  public ActionForward loadUpdate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
    request.setAttribute("instructWorkload",
        utilService.load(InstructWorkload.class, getLong(request, "instructWorkloadId")));
  ...
  public ActionForward doUpdate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    InstructWorkload instructWorkload = (InstructWorkload) utilService.get(InstructWorkload.class,
  ...
  public ActionForward doDelete(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List instructWorkloads = utilService.load(InstructWorkload.class, "id",
        SeqStringUtil.transformToLong(instructWorkloadIds));
   ...
   * @throws Exception
   */
  public ActionForward doAffirmSelect(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String instructWorkloadIds = request.getParameter("instructWorkloadIds");
    String affirmType = request.getParameter("affirmType");
    String affirmEstate = request.getParameter("affirmEstate");
    instructWorkloadService.affirmType(affirmType, instructWorkloadIds, Boolean.valueOf(affirmEstate)
        .booleanValue());
   ...
   * @throws Exception
   */
  public ActionForward doAffirmAll(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String affirmType = request.getParameter("affirmType");
    String affirmEstate = request.getParameter("affirmEstate");
    instructWorkloadService.affirmALl(getStdTypeIdSeq(request), affirmType, Boolean.getBoolean(affirmEstate));
    return redirect(request, "search", "info.confirm.success");
  }
}
