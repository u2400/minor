...
public class SpecialityAction extends SpecialitySearchAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (ValidEntityPredicate.INSTANCE.evaluate(speciality)) {
      if (!DataAuthorityUtil.isInDataRealm("Speciality", speciality, stdTypeDataRealm, departDataRealm)) return forwardError(
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    // 检查是否重复
    if (utilService
        .duplicate(Speciality.class, specialityId, "code", request.getParameter("speciality.code"))) { return forward(
    ...
    try {
      ...
      logHelper.info(request, "Failure save or update a speciality with name:" + speciality.getName(), e);
      return forward(mapping, request, new String[] { "entity.speciality", "error.model.existed" }, "error");
    } catch (Exception e) {
      logHelper.info(request, "Failure save or update a speciality with name:" + speciality.getName(), e);
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Transfer transfer = ImporterServletSupport.buildEntityImporter(request, Speciality.class, tr);
