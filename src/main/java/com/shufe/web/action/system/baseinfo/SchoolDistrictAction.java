...
public class SchoolDistrictAction extends BaseInfoAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    SchoolDistrict district = (SchoolDistrict) getEntity(request, SchoolDistrict.class, "schoolDistrict");
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    // 检查是否重复
    if (utilService.duplicate(SchoolDistrict.class, districtId, "code",
        request.getParameter("schoolDistrict.code"))) { return forward(request, new Action("", "edit"),
        "error.code.existed"); }

    SchoolDistrict district = (SchoolDistrict) populateEntity(request, SchoolDistrict.class, "schoolDistrict");
    try {
      if (district.isVO()) {
      ...
      logHelper.info(request, "Failure save or update a School District named" + district.getName(), e);
      return forward(mapping, request, new String[] { "entity.schoolDistrict", "error.model.existed" },
          "error");
    } catch (Exception e) {
      logHelper.info(request, "Failure save or update a School District named" + district.getName(), e);
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(districtId)) return forward(mapping, request, new String[] {
        "entity.schoolDistrict", "error.model.id.needed" }, "error");
    SchoolDistrict district = (SchoolDistrict) baseInfoService.getBaseInfo(SchoolDistrict.class,
