...
public class SpecialityAspectSearchAction extends BaseInfoAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    addCollection(request, "specialityAspects",
        utilService.search(baseInfoSearchHelper.buildSpecialityAspectQuery(request)));
    return forward(request);
  }
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(specialityAspectId)) return forward(mapping, request, new String[] {
        "entity.specialityAspect", "error.model.id.needed" }, "error");
