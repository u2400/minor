...
public class DepartmentSearchAction extends BaseInfoAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    addCollection(request, "departments",
        utilService.search(baseInfoSearchHelper.buildDepartmentQuery(request)));
    return forward(request);
  }
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(departmentId)) { return forward(mapping, request, new String[] {
        "entity.department", "error.model.id.needed" }, "error"); }
