...
public class CourseAction extends CourseSearchAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (ValidEntityPredicate.INSTANCE.evaluate(course)) {
      if (!DataAuthorityUtil.isInDataRealm("Course", course, stdTypeDataRealm, null)) return forwardError(
          mapping, request, "error.stdType.dataRealm.insufficient");
    }
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    // 检查是否重复
    if (utilService.duplicate(Course.class, courseId, "code", courseCode)) { return forward(request,
    ...
    try {
      ...
      logHelper.info(request, "Failure save or update cource with name:" + course.getName(), e);
      return forward(mapping, request, new String[] { "entity.course", "error.model.existed" }, "error");
    } catch (Exception e) {
      logHelper.info(request, "Failure save or update cource with name:" + course.getName(), e);
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    transfer.addListener(new ImporterForeignerListener(utilService))
        ...
        .addListener(new CourseImportListener(courseService));
