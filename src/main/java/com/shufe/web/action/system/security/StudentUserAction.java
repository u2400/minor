...
public class StudentUserAction extends RestrictionSupportAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isNotEmpty(stdCode)) {
      ...
      if (null == std) return forward(mapping, request, new String[] { "entity.student",
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Student std = studentService.getStudent(savedUser.getName());
    if (null == std) return forward(mapping, request, new String[] { "entity.student",
        "error.model.notExsits" }, "error");
  ...
  public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(stdCodeSeq)) return forward(mapping, request, new String[] { "entity.student",
