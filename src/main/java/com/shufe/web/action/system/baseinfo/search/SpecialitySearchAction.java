...
public class SpecialitySearchAction extends BaseInfoAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    addCollection(request, "specialities",
        utilService.search(baseInfoSearchHelper.buildSpecialityQuery(request)));
    return forward(request);
  }
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(specialityId)) return forward(mapping, request, new String[] {
        "entity.speciality", "error.model.id.needed" }, "error");
