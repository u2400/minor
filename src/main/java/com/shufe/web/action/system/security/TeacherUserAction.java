...
public class TeacherUserAction extends RestrictionSupportAction {
  ...
  public ActionForward index(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(departIdSeq)) { return forwardError(mapping, request,
   ...
   * @throws Exception
   */
  public ActionForward promptToManager(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isNotEmpty(teacherNo)) {
      ...
      if (null == teacher) return forward(mapping, request, new String[] { "entity.teacher",
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    User user = null;
    if (null != userId || userId.intValue() != 0) user = (User) utilService.get(User.class, userId);
    else {
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (userId.equals(1L)) return forward(mapping, request, new String[] { "entity.teacher", "不能更改超级管理员密码" },
        "error");

    User savedUser = userService.get(userId);
    if (null == savedUser) return forward(mapping, request, new String[] { "entity.student",
        "error.model.notExist" }, "error");

    Teacher teacher = teacherService.getTeacherByNO(savedUser.getName());
    if (null == teacher) return forward(mapping, request, new String[] { "entity.teacher",
        "error.model.notExist" }, "error");

    if (!getDeparts(request).contains(teacher.getDepartment())) { return forward(mapping, request,
        new String[] { "entity.teacher", "数据权限不足" }, "error"); }
  ...
  public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String teacherNoSeq = request.getParameter("teacherNos");
    if (StringUtils.isEmpty(teacherNoSeq)) return forward(mapping, request, new String[] { "entity.teacher",
        "error.model.notExist" }, "error");
