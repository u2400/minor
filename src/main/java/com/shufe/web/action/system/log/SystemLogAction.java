...
public class SystemLogAction extends DispatchBasicAction {
  ...
  private EntityQuery buildQuery(HttpServletRequest request, boolean isLimited) {
    ...
    if (null != beginDate && null != endDate) {
      ...
      query.add(new Condition("sysLog.time >= (:begin) and sysLog.time <= (:end)", beginDate, c.getTime()));
    }
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    request.setAttribute("sysLog", utilService.load(SystemLog.class, getLong(request, "sysLogId")));
    return forward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward removeAll(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
