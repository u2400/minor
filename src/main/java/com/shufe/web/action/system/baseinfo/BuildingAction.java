...
public class BuildingAction extends BaseInfoAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    addCollection(request, "buildings", utilService.search(baseInfoSearchHelper.buildBuildingQuery(request)));
    return forward(request);
  }
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    // 检查是否重复
    if (utilService.duplicate(Building.class, buildingId, "code", request.getParameter("building.code"))) { return forward(
    ...
    try {
      ...
      logHelper.info(request, "Failure occured in save or update  building named " + building.getName(), e);
      return forward(mapping, request, new String[] { "entity.building", "error.model.existed" }, "error");
    } catch (Exception e) {
      logHelper.info(request, "Failure occured in save or update  building named " + building.getName(), e);
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(buildingId)) return forward(mapping, request, "building.id.NotExist", "failure");
    Building building = (Building) baseInfoService.getBaseInfo(Building.class, Long.valueOf(buildingId));
    addEntity(request, building);
    return forward(request);
  }
}
