...
public class DocumentDownloadAction extends FileAction {
  ...
  public ActionForward download(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null != documentId) document = (Document) utilService.get(Document.class, documentId);
    if (null == document) {
    ...
    download(request, response, getFileRealPath(FilePath.DOC, request) + document.getPath(), fileName);
    return null;
  }
  ...
  public ActionForward index(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (curCategory.equals(EamsRole.STD_USER)) {
      ...
      query
          .add(new Condition(
              "sysdate>document.startDate and sysdate<document.finishDate or document.startDate is null or document.finishDate is null"));
