...
public class AdminClassAction extends AdminClassSearchAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (ValidEntityPredicate.INSTANCE.evaluate(adminClass)) {
      if (!DataAuthorityUtil.isInDataRealm("AdminClass", adminClass, getStdTypeIdSeq(request),
          getDepartmentIdSeq(request))) { return forwardError(mapping, request,
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    // 检查是否重复
    if (utilService
        .duplicate(AdminClass.class, adminClassId, "code", request.getParameter("adminClass.code"))) { return forward(
    ...
    try {
      ...
      return forward(mapping, request, new String[] { "entity.adminClass", "error.model.existed" }, "error");
    } catch (Exception e) {
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Transfer transfer = ImporterServletSupport.buildEntityImporter(request, AdminClass.class, tr);
    ...
    transfer.addListener(new ImporterForeignerListener(utilService))
        .addListener(new ImporterCodeGenListener(codeGenerator))
        .addListener(new AdminClassImportListener(adminClassService));
