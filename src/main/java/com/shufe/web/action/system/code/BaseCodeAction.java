...
public class BaseCodeAction extends DispatchBasicAction {
  ...
  private void commonEdit(HttpServletRequest request) {
    ...
    BaseCode code = null;
    if ((null != codeId) && StringUtils.isNotEmpty(codeName)) code = baseCodeService
        .getCode(codeName, codeId);
    if (null == code) {
      code = new BaseCode();
    }
    Coder coder = (Coder) utilService.load(Coder.class, "className", codeName).iterator().next();
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    try {
      String shortName = StringUtils.capitalize(getShortName(request.getParameter("codeName")));
   ...
   * @throws Exception
   */
  public ActionForward editAlterReason(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward editCourseType(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    commonEdit(request);
    return getExtEditForward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward editGradeType(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward editHSKDegree(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    commonEdit(request);
    return getExtEditForward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward editPunishmentType(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    commonEdit(request);
    return getExtEditForward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward editMarkStyle(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    commonEdit(request);
    return getExtEditForward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward editPress(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward editPublication(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addCollection(request, "publicationLevels", baseCodeService.getCodes(PublicationLevel.class));
    commonEdit(request);
    return getExtEditForward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward editTeacherTitle(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    commonEdit(request);
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (!codeGenerator.isValidCode(code)) {
      ...
      if (codeGenerator.isValidCode(code)) {
        ...
        messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("system.codeGen.failure"));
        addErrors(request, messages);
        return forward(request, new Action(this.getClass(), "edit"));
      }
    }

    if (utilService.duplicate(codeClass, codeId, "code", baseCode.getCode())) { return forward(request,
        new Action("", "edit"), "error.code.existed"); }
    try {
      baseCodeService.saveOrUpdate(baseCode);
    } catch (PojoExistException e) {
      return forwardError(mapping, request, new String[] { "entity.baseCode", "error.model.existed" });
    } catch (Exception e) {
      e.printStackTrace();
    }
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (!datas.isEmpty()) {
      ...
      if (code.hasExtPros()) { return forward(request, EXT + getShortName(request.getParameter("codeName"))
          + "List"); }
    }
    return forward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward batchUpdateState(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String codeName = request.getParameter("codeName");
