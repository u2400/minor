...
public class TeachQualityStatisticAction extends RestrictionSupportAction {
  ...
  public void setTeachQualityStatisticService(TeachQualityStatisticService teachQualityStatisticService) {
    this.teachQualityStatisticService = teachQualityStatisticService;
  }

  public ActionForward statEvaluatePage(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List condtionCalendars = teachCalendarService.getTeachCalendars(getLong(request, "stdTypeId"),
        request.getParameter("yearStart"), request.getParameter("termStart"),
    ...
    if (condtionCalendars.isEmpty()) {
      ...
      Map displayMap = teachQualityStatisticService.statEvaluatePageByNum(newSegs, condtionCalendars,
          studentTypeService.getStdTypeIdSeqUnder(getLong(request, "stdTypeId")), null,
          Float.valueOf(excellentMark).floatValue());
