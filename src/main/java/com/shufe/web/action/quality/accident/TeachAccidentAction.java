...
public class TeachAccidentAction extends TeachAccidentSearchAction {
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    TeachAccident teachAccident = (TeachAccident) populateEntity(request, TeachAccident.class,
        "teachAccident");
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == entityId) {
      ...
      entity = (TeachAccident) utilService.get(TeachAccident.class, entityId);
    }
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    utilService.remove(utilService.load(TeachAccident.class, "id", SeqStringUtil.transformToLong(ids)));
