...
public class TeachAccidentSearchAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    EntityQuery query = new EntityQuery(TeachAccident.class, "teachAccident");
    populateConditions(request, query);
    query.setLimit(getPageLimit(request));
    query.addOrder(OrderUtils.parser(request.getParameter("orderBy")));
    DataRealmUtils.addDataRealms(query, new String[] { "", "teachAccident.task.arrangeInfo.teachDepart.id" },
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    TeachAccident teachAccident = (TeachAccident) utilService.load(TeachAccident.class, Long.valueOf(id));
   ...
   */
  public void setTeachAccidentService(TeachAccidentService teachAccidentService) {
