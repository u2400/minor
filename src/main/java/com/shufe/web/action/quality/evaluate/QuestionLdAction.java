 ...
 * @author chaostone
 */
public class QuestionLdAction extends RestrictionExampleTemplateAction {
  ...
  protected EntityQuery buildQuery(HttpServletRequest request) {
    ...
    entityQuery.add(new Condition(getEntityName() + ".department.id in (:departIds)", SeqStringUtil
