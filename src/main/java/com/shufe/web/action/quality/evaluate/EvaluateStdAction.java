...
public class EvaluateStdAction extends RestrictionSupportAction {
  ...
  public ActionForward list(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    TeachCalendar teachCalendar = teachCalendarService.getTeachCalendar(getLong(request, "calendar.id"));
  ...
  public ActionForward loadQuestionnaire(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if ("evaluate".equals(evaluateState)) {
      ...
      List courseTasks = utilService.load(CourseTake.class, new String[] { "task.id", "student.id" },
          new Object[] { taskId, student.getId() });
      ...
      EvaluateResult result = evaluateResultService.getResultByStdIdAndTaskId(student.getId(),
          teachTask.getId(), teacherId);
      if (null == result) {
        request.setAttribute("message", "error.dataRealm.insufficient");
        return forward(request, "errors");
      }
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null != resultId) {
      ...
      CourseTake courseTake = (CourseTake) utilService
          .load(CourseTake.class, new String[] { "task.id", "student.id" },
