...
public class EvaluateQuerySwitchAction extends RestrictionSupportAction {
  ...
  public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List queryButtons = utilService.load(EvaluateQuerySwitch.class, "teachCalendar", teachCalendars);
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    DataRealmUtils.addDataRealms(entityQuery, new String[] { "switch.teachCalendar.studentType.id", "" },
        getDataRealmsWith(getLong(request, "switch.teachCalendar.studentType.id"), request));
   ...
   * @throws Exception
   */
  public ActionForward operate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    if ("select".equals(isAll)) {
      ...
      querySwitchs = utilService.load(EvaluateQuerySwitch.class, "id", SeqStringUtil.transformToLong(idSeq));
    } else {
      EntityQuery entityQuery = new EntityQuery(EvaluateQuerySwitch.class, "switch");
