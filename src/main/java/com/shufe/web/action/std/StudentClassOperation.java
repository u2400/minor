...
public class StudentClassOperation extends StudentSearchSupportAction {
   ...
   * @return
   */
  public ActionForward autoSplitClassForm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
    searchStudent(form, request, "AdminClassManager");
    Results.addObject(
        "adminClassList",
        utilService.load(AdminClass.class, "id",
   ...
   * @return
   */
  public ActionForward autoSplitClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @return
   */
  public ActionForward splitClassForm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
    searchStudent(form, request, "AdminClassManager");
    Results.addObject("adminClassList",
        utilService.load(AdminClass.class, "id", new Object[] { SeqStringUtil.transformToLong(StringUtils
            .split(request.getParameter("classId"), ",")) }));
   ...
   * @return
   */
  public ActionForward splitClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @return
   */
  public ActionForward detailByStudent(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
  ...
  public ActionForward assignStudentClassForm(ActionMapping mapping, ActionForm form,
    ...
    query.add(new Condition("std.id in(:ids)", SeqStringUtil.transformToLong(request.getParameter("stdId"))));
   ...
   * @return
   */
  public ActionForward assignStudentClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) {
  ...
  public ActionForward maintainStudentClassForm(ActionMapping mapping, ActionForm form,
    ...
    List studentList = utilService.load(Student.class, "id",
        SeqStringUtil.transformToLong(request.getParameter("stdIds")));
  ...
  public ActionForward maintainStudentClass(ActionMapping mapping, ActionForm form,
    ...
    studentService.updateStudentAdminClass(getLong(request, "stdId"),
        SeqStringUtil.transformToLong(request.getParameter("adminClassIds")), null);
   ...
   * @throws Exception
   */
  public ActionForward cancelStudentClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    return redirect(request, new Action("adminClassManager", "classManager"), "info.delete.success",
        (String[]) null);
  }
   ...
   * @throws Exception
   */
  public ActionForward updateStudentClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    return redirect(request, new Action("adminClassManager", "classManager"), "info.save.success",
        (String[]) null);
  }

  public ActionForward resetStudentClass(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long[] stdIdArray = SeqStringUtil.transformToLong(request.getParameter("stdId"));
    studentService.batchResetStudentClass(stdIdArray);
    return redirect(request, new Action("studentClassManager", "studentClassManager"), "info.delete.success",
        (String[]) null);
  }
  ...
  public ActionForward setClassStudentForm(ActionMapping mapping, ActionForm form,
    ...
    Results.addObject("adminClass", utilService.load(AdminClass.class, getLong(request, "classId")));
