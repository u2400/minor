...
public class FreshmanAction extends DispatchBasicAction {
  ...
  public ActionForward courseTable(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == adminClass) { return forwardError(mapping, request, "adminClass.notExists"); }
    // 查找课表设置参数
    ...
    if (!orders.isEmpty()) {
      ...
      Collections.sort(resources, new PropertyComparator(order.getProperty(),
   ...
   * @throws Exception
   */
  public ActionForward stdPlanInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    if (null == speciality) { return forwardError(mapping, request, "speciality.notExists"); }
