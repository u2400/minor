...
public class Speciality2ndSignUpAction extends DispatchBasicAction {
   ...
   * @return
   */
  public ActionForward signUpSettingList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Float GPA = gradePointService.statStdGPA(std, null, new MajorType(MajorType.FIRST), Boolean.TRUE);
  ...
  public ActionForward signUp(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (Boolean.TRUE.equals(setting.getIsRestrictSubjectCategory())) {
      for (Iterator iter = specialitySettings_temp.iterator(); iter.hasNext();) {
        ...
        if (!std.getFirstMajor().getSubjectCategory().getId()
   ...
   * @return
   */
  public ActionForward submitSignUp(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @return
   */
  public ActionForward cancelSignUp(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
