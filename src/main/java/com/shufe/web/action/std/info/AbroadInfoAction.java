...
public class AbroadInfoAction extends RestrictionSupportAction {
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    AbroadStudentInfo info = (AbroadStudentInfo) populateEntity(request, AbroadStudentInfo.class,
        "abroadStudentInfo");
   ...
   * @throws Exception
   */
  public ActionForward statDeadline(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    setDataRealm(request, hasStdTypeCollege);
   ...
   * @throws Exception
   */
  public ActionForward statAbroadStdList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    if (StringUtils.isEmpty(deadlineType) || StringUtils.equals(deadlineType, "visa")) {
      query.add(new Condition("student.abroadStudentInfo.visaDeadline <= (:visa)", deadlineDate));
    } else if (StringUtils.equals(deadlineType, "passport")) {
      query.add(new Condition("student.abroadStudentInfo.passportDeadline <= (:passport)", deadlineDate));
    } else {
      query.add(new Condition("student.abroadStudentInfo.resideCaedDeadline <= (:resideCaed)", deadlineDate));
    }
