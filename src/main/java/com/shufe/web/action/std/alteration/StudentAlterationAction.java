...
import com.ekingstar.commons.transfer.importer.StudentAlterationImporter;
 ...
 * @author chaostone
 */
public class StudentAlterationAction extends StudentAlterationSearchAction {
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Transfer transfer = buildEntityImporter(request, StudentAlteration.class, tr);
  ...
  protected EntityImporter buildEntityImporter(HttpServletRequest request, Class clazz, TransferResult tr) {
    try {
      ...
      for (Iterator iter = items.iterator(); iter.hasNext();) {
        ...
        if (!element.isFormField()) {
          ...
          if (fileName.endsWith(".xls")) {
            ...
            EntityImporter importer = new StudentAlterationImporter(clazz);
