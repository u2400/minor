...
public class TeachPlanArrangeAlterationAction extends RestrictionSupportAction {
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "alteration",
        utilService.load(TeachPlanArrangeAlteration.class, getLong(request, "alterationId")));
    return forward(request);
  }

  public ActionForward groupsInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "alteration",
        utilService.load(TeachPlanArrangeAlteration.class, getLong(request, "alterationId")));
    return forward(request);
  ...
  public ActionForward planCoursesInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "alteration",
        utilService.load(TeachPlanArrangeAlteration.class, getLong(request, "alterationId")));
    return forward(request);
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Collection alterations = utilService.load(TeachPlanArrangeAlteration.class, "id", alterationIds);
