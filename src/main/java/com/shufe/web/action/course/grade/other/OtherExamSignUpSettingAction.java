...
public class OtherExamSignUpSettingAction extends RestrictionSupportAction {
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null != settingId) {
      setting = (OtherExamSignUpSetting) utilService.load(OtherExamSignUpSetting.class, settingId);
    } else {
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List settings = utilService.load(OtherExamSignUpSetting.class, "id",
        SeqStringUtil.transformToLong(settingIds));
