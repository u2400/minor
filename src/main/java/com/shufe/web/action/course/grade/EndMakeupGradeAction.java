...
public class EndMakeupGradeAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward courseList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    query
        .setSelect("select distinct examTake.task.course,examTake.task.arrangeInfo.teachDepart,examTake.activity.time");
  ...
  public ActionForward gradeTable(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    request.setAttribute("calendar", teachCalendarService.getTeachCalendar(calendarId));
    return forward(request);
  }
  ...
  public ActionForward batchAddGrade(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    request.setAttribute("MAKEUP", baseCodeService.getCode(ExamType.class, ExamType.AGAIN));
    return forward(request);
  }
  ...
  private void getExamTakeAndMakeupExam(HttpServletRequest request) {
    ...
    request.setAttribute("teachDepart",
