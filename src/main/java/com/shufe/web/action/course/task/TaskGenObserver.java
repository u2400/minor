...
public class TaskGenObserver extends OutputProcessObserver {
  ...
  public void notifyFinish() throws IOException {
    outputNotify(OutputWebObserver.good, new OutputMessage("info.taskGenInit.finish", ""), false);
  }
  ...
  public void outputNotify(int term, TeachPlan plan, String messageKey, boolean increaceProcess)
      throws IOException {
