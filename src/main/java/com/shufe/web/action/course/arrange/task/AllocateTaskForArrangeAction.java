...
public class AllocateTaskForArrangeAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward index(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == calendarId) {
      ...
      addSingleParameter(request, CALENDAR_STDTYPES_KEY, // 该值为calendarStdTypes
          getCalendarStdTypesOf(((StudentType) getAttribute(request, "studentType")).getId(), request));
    }
    // calendarStdTypes
    Set departments = new HashSet();
    departments.addAll(baseInfoService.getBaseInfos(Department.class));
    Set allocations = new HashSet();
    allocations.addAll(utilService.load(TaskInDepartment.class, "calendar.id", calendar.getId()));
  ...
  public ActionForward searchAll(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    EntityQuery query = teachTaskSearchHelper.buildTaskQuery(request, Boolean.TRUE);
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    EntityQuery query = buildTaskQuery(request,
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Long[] primaryKey = SeqStringUtil.transformToLong(StringUtils.split(get(request, "primaryKey"), "_"));
    EntityQuery query = new EntityQuery(TaskInDepartment.class, "taskIn");
   ...
   * @throws Exception
   */
  public ActionForward taskInner(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward autoInner(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    TeachCalendar calendar = teachCalendarService.getTeachCalendar(getLong(request, "calendarId"));
    Collection taskIns = utilService.load(TaskInDepartment.class, "calendar.id", calendar.getId());
    Map taskInMap = new HashMap();
   ...
   * @throws Exception
   */
  public ActionForward taskOutter(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long[] taskIds = SeqStringUtil.transformToLong(get(request, "taskIds"));
    Set tasks = new HashSet();
    tasks.addAll(utilService.load(TeachTask.class, "id", taskIds));
    Long taskInId = getLong(request, "taskInId");
    TaskInDepartment taskIn = (TaskInDepartment) utilService.get(TaskInDepartment.class, taskInId);
