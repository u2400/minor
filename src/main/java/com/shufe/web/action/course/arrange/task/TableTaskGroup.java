...
public class TableTaskGroup implements Comparable {
  ...
  public void addTask(TeachTask task) {
    ...
    if (null == actualCredit) {
      ...
      actualCredit = new Float(actualCredit.floatValue() + task.getCourse().getCredits().floatValue());
    }
  }
  ...
  public int compareTo(Object object) {
    ...
    return new CompareToBuilder().append(this.type.getPriority(), myClass.type.getPriority()).toComparison();
  }
