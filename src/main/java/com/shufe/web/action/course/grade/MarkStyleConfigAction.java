...
public class MarkStyleConfigAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward addConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List defaultConfigs = utilService.load(DefaultConverterConfig.class, "id", defaultConfigIds);
  ...
  public ActionForward setting(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    request.setAttribute("defaultConfig",
        utilService.load(DefaultConverterConfig.class, getLong(request, "defaultConfigId")));
    return forward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward saveConfigSettng(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    // 修改配置项
      ...
      for (int i = 0; i < configItemIds.length; i++) {
        DefaultConverterItem configItem = (DefaultConverterItem) itemMap.get(configItemIds[i]);
   ...
   * @throws Exception
   */
  public ActionForward removeConfigSettng(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    utilService.remove(utilService.load(DefaultConverterItem.class, "id",
        SeqStringUtil.transformToLong(get(request, "configItemIds"))));
    return redirect(request, "setting", "info.action.success");
  }
