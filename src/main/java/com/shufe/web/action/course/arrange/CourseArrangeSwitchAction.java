...
public class CourseArrangeSwitchAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    List courseArrangeSwitchS = utilService.load(CourseArrangeSwitch.class, "calendar", teachCalendars);
  ...
  public ActionForward openedOrClosed(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long[] courseArrangeSwitchIds = SeqStringUtil.transformToLong(get(request, "courseArrangeSwitchIds"));
    List courseArrangeSwitchList = utilService.load(CourseArrangeSwitch.class, "id", courseArrangeSwitchIds);
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "arrangeSwitch",
        utilService.load(CourseArrangeSwitch.class, getLong(request, "courseArrangeSwitchId")));
    return forward(request);
  }

  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    utilService.saveOrUpdate(populateEntity(request, CourseArrangeSwitch.class, "switch"));
