...
public class TeachPlanActivityStatAction extends TeachPlanSearchAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    for (Iterator it = teachPlans.iterator(); it.hasNext();) {
      ...
      query.add(new Condition("task.teachClass.enrollTurn = :enrollTurn", plan.getEnrollTurn()));
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null == planId) { return forwardError(mapping, request, "error.model.id.needed"); }
