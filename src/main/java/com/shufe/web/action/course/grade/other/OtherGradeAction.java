...
public class OtherGradeAction extends OtherGradeSearchAction {
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    grade.setCalendar(teachCalendarService.getTeachCalendar(getLong(request, "calendar.studentType.id"),
        request.getParameter("calendar.year"), request.getParameter("calendar.term")));
    Map params = getParams(request, "otherGrade");
    populate(params, grade);
    String score = request.getParameter("score");
    MarkStyle markStyle = (MarkStyle) utilService.get(MarkStyle.class, grade.getMarkStyle().getId());
  ...
  public ActionForward importData(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Transfer transfer = ImporterServletSupport.buildEntityImporter(request, OtherGrade.class, tr);
    ...
    transfer.addListener(new ImporterForeignerListener(utilService)).addListener(
        new OtherGradeImportListener(utilService.getUtilDao(), teachCalendarService.getTeachCalendarDAO()));
