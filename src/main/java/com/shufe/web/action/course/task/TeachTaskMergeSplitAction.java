...
public class TeachTaskMergeSplitAction extends TeachTaskSearchAction {
  ...
  public ActionForward mergeSetting(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (taskIds.indexOf(",") == -1) { return forward(mapping, request, "error.teachTask.id.multiNeeded",
        "error"); }
   ...
   * @throws Exception
   */
  public ActionForward affirmSetting(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ActionForward merge(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (StringUtils.isEmpty(reservedId) || StringUtils.isEmpty(taskIdSeq)) { return forward(mapping, request,
   ...
   * @throws Exception
   */
  public ActionForward splitSetting(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    if (!StringUtils.isNumeric(splitNum)) { return forwardError(mapping, request, "error.splitNum.notNum"); }
  ...
  public ActionForward split(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    String splitNum = get(request, "splitNum");
    if (!StringUtils.isNumeric(splitNum)) { return forward(mapping, request, "error.splitNum.notNum", "error"); }
    ...
    try {
      ...
      teachTaskService.split(task, Integer.parseInt(splitNum), splitMode,
          SeqStringUtil.transformToInteger(splitUnitNums));
    } catch (Exception e) {
