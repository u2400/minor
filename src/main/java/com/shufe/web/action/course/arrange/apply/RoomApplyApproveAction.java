...
public class RoomApplyApproveAction extends RoomApplyDepartApproveAction {
   ...
   * @throws Exception
   */
  public ActionForward applyRoomSetting(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
   ...
   * @throws Exception
   */
  public ActionForward getFreeRooms(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    if (null != schoolDistrictId) {
      room.setSchoolDistrict((SchoolDistrict) baseInfoService.getBaseInfo(SchoolDistrict.class,
          schoolDistrictId));
    }
    net.ekingstar.common.detail.Pagination rooms = teachResourceService.getFreeRoomsOf(null, times, room,
        Activity.class, getPageNo(request), getPageSize(request));
  ...
  public ActionForward approve(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    roomApplyService.approve(roomApply, classroomSet);

    logHelper.info(request, LogHelper.DELETE + " + " + LogHelper.UPDATE + " + " + LogHelper.INSERTE);
   ...
   * @throws Exception
   */
  public ActionForward adjustFeeForm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    request.setAttribute("roomApply", utilService.get(RoomApply.class, getLong(request, "roomApplyId")));
    return forward(request);
  }
   ...
   * @throws Exception
   */
  public ActionForward changeFee(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    RoomApply roomApply = (RoomApply) utilService.get(RoomApply.class, getLong(request, "roomApplyId"));
