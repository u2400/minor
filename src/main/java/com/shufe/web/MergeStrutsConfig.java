...
public class MergeStrutsConfig {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Node global_exceptions = (Node) globeConf.selectSingleNode("//global-exceptions").clone();
    ...
    try {
      ...
      XMLWriter output = new XMLWriter(new FileWriter(new File("src/main/webapp/WEB-INF/struts-config.xml")),
          format);
