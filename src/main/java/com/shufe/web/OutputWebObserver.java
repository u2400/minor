...
public class OutputWebObserver implements OutputObserver {
  ...
  public OutputWebObserver(PrintWriter writer, MessageResources resourses, Locale locale) {
    this.writer = writer;
  ...
  public String messageOf(String key, Object arg0) {
    if (StringUtils.isNotEmpty(key)) return resourses.getMessage(locale, key, arg0);
    else return "";
  }
