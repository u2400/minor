...
public class StdGradeHelper {
  ...
  public void searchStdGrade(HttpServletRequest request, Student std, GradeService gradeService,
    ...
    // request.setAttribute("stdGP", gradePointService.statStdGPA(std, gradeExample.getMajorType(),
    // Boolean.TRUE));
    request.setAttribute("stdGP", gradePointService.statStdGPA(std, grades));
