...
public abstract class SearchHelper {
   ...
   * @return
   */
  public String getCalendarStdTypeIdSeqOf(Long parentStdTypeId, HttpServletRequest request, String moduleName) {
  ...
  public List getCalendarStdTypesOf(Long parentStdTypeId, HttpServletRequest request, String moduleName) {
