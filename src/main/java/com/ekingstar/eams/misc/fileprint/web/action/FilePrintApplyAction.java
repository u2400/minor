...
public class FilePrintApplyAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    query.add(new Condition(" filePrintApplication.applyBy=:applyBy", getUser(request.getSession())));
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null != filePrintApplication.getId()) {
      FilePrintApplication application = (FilePrintApplication) utilService.load(FilePrintApplication.class,
          filePrintApplication.getId());
    ...
    if (!file.exists()) {
      response.getWriter().write(
          "without file path:[" + FilePath.getRealPath(config, FilePath.DOC, defaultPath) + "/"
              + new String(filePrintApplication.getFilePath().getBytes(), "ISO-8859-1") + "]");
      return null;
    }
