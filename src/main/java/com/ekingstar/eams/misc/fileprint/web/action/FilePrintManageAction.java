...
public class FilePrintManageAction extends CalendarRestrictionSupportAction {
  ...
  public ActionForward materialList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (!"".equals(filePrintApplicationIdSeq)) {
      FilePrintApplication filePrintApplication = (FilePrintApplication) utilService.get(
          FilePrintApplication.class, Long.valueOf(filePrintApplicationIdSeq));
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    String filePrintMaterialId = request.getParameter("filePrintMaterialId");
    ...
    if (!"".equals(filePrintMaterialId)) {
      FilePrintMaterial filePrintMaterial = (FilePrintMaterial) utilService.get(FilePrintMaterial.class,
          Long.valueOf(filePrintMaterialId));
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    FilePrintMaterial filePrintMaterial = (FilePrintMaterial) populateEntity(request,
        FilePrintMaterial.class, "filePrintMaterial");
    filePrintMaterial.setPayed(new Float((filePrintMaterial.getPayedOne().floatValue())
        * (filePrintMaterial.getValue().intValue())));
