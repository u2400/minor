...
public class AuditStandardSearchAction extends RestrictionSupportAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    AuditStandard auditStandard = (AuditStandard) RequestUtil.populate(request, AuditStandard.class,
        "auditStandard");
    int pageNo = ((Integer) dynaForm.get("pageNo")).intValue();
    int pageSize = ((Integer) dynaForm.get("pageSize")).intValue();
    Pagination auditStandardList = auditStandardService.searchAuditStandard(auditStandard, pageNo, pageSize,
