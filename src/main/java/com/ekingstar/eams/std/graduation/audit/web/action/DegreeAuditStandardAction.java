...
public class DegreeAuditStandardAction extends RestrictionExampleTemplateAction {
   ...
   * @throws Exception
   */
  public ActionForward ruleConfig_1st(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    Long standardId = getLong(request, "standardId");
    if (null != standardId) {
      request.setAttribute("standard", utilService.get(DegreeAuditStandard.class, standardId));
    }
   ...
   * @throws Exception
   */
  public ActionForward ruleConfig_2nd(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    DegreeAuditStandard degreeAuditStandard = (DegreeAuditStandard) populateEntity(request, entityClass,
        "standard");
   ...
   * @throws Exception
   */
  public ActionForward ruleConfig_3rd(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    utilService.saveOrUpdate(degreeAuditStandard);
    request.setAttribute("otherExamCategories", baseCodeService.getCodes(OtherExamCategory.class));
