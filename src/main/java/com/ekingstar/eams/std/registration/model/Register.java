 ...
 * @author chaostone
 */
public class Register extends LongIdObject implements com.ekingstar.eams.std.registration.Register {
  ...
  public Register(TeachCalendar calendar, Student std, Timestamp registerAt, String remark,
      RegisterState state, Boolean isPassed, Boolean isTuitionFeeCompleted) {
    super();
