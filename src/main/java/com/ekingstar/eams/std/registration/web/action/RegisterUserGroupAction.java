...
public class RegisterUserGroupAction extends RestrictionExampleTemplateAction {
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    RegisterUserGroup userGroup = (RegisterUserGroup) populateEntity(request, RegisterUserGroup.class,
        "registerUserGroup");
   ...
   * @throws Exception
   */
  public ActionForward maintenance(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    RegisterUserGroup userGroup = (RegisterUserGroup) utilService.get(RegisterUserGroup.class,
        getLong(request, "id"));
  ...
  public ActionForward addUser(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    RegisterUserGroup userGroup = (RegisterUserGroup) utilService.get(RegisterUserGroup.class, id);
