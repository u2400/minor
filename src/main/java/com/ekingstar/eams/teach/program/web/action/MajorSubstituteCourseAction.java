...
public class MajorSubstituteCourseAction extends RestrictionExampleTemplateAction {
  ...
  public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    Long departmentTypeId = getLong(request, "majorCourse.department.id");
    if (null != stdTypeId) {
      dataRealmHelper.addStdTypeTreeDataRealm(query, stdTypeId, "majorCourse.stdType.id", request);
      query.add(new Condition("majorCourse.stdType.id = :stdTypeId", stdTypeId));
    }
    if (null != departmentTypeId) {
      query.add(new Condition("majorCourse.department.id = :departmentTypeId", departmentTypeId));
    }
  ...
  public ActionForward info(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    addSingleParameter(request, "majorCourse",
        utilService.load(MajorSubstituteCourse.class, getLong(request, "majorCourseId")));
    return forward(request);
  }
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (null != majorCourseId) {
      addSingleParameter(request, "majorCourse", utilService.load(MajorSubstituteCourse.class, majorCourseId));
    }
  ...
  public ActionForward selector(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    if (Boolean.TRUE.equals(isWithPlan)) {
      ...
      query.add(QueryRequestSupport.extractConditions(request, com.shufe.model.system.baseinfo.Course.class,
          "course", null));
      ...
      populateConditions(request, query);
      if (StringUtils.isNotEmpty(courseSeq)) {
        query.add(new Condition("course.id not in (:courseId)", SeqStringUtil.transformToLong(courseSeq)));
      }
      query.add(QueryRequestSupport.extractConditions(request, com.shufe.model.system.baseinfo.Course.class,
          "course", null));
      query.setLimit(getPageLimit(request));
  ...
  public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    query.add(new Condition("majorCourse.enrollTurn = :enrollTurn", get(request, "majorCourse.enrollTurn")));
    query
        .add(new Condition("majorCourse.stdType.id = :stdTypeId", getLong(request, "majorCourse.stdType.id")));
    ...
    if (CollectionUtils.isNotEmpty(utilService.search(query))) { return forward(request, new Action(this,
        "edit"), "info.save.failure.overlap"); }
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    utilService.remove(utilService.load(MajorSubstituteCourse.class, "id",
        SeqStringUtil.transformToLong(get(request, "majorCourseIds"))));
