...
<html>
 <head>
  ...
  <title>华东政法大学教学管理信息系统</title>
  <link href="css/default.css" rel="stylesheet" type="text/css">
  <link href="css/messages.css" rel="stylesheet" type="text/css">
  <link href="css/toolBar.css" rel="stylesheet" type="text/css">
 </head>
 <script language="JavaScript" type="text/JavaScript" src="scripts/StringUtils.js?ver=20120518"></script>
 ...
 <#macro yesOrNoOptions(selected)>
 	<option value="0" <#if "0"==selected> selected </#if> ><@msg.message key="common.no" /></option> 
    <option value="1" <#if "1"==selected> selected </#if>><@msg.message key="common.yes" /></option> 
    <option value="" <#if ""==selected> selected </#if>><@msg.message key="common.all" /></option> 
 </#macro>
 ...
 <#macro getMessage><#assign error><@html.errors/></#assign><div class="message fade-ffff00"  id="error">${error}</div><div class="message fade-ffff00"  id="message"><#if RequestParameters.messages?exists><#list RequestParameters.messages?split(",") as message><#if (message?length>2)><@msg.message key="${message}"/></#if></#list></#if></div></#macro>
