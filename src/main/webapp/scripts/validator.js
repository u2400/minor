...
function isShortTimeNoBreakSign(s_time) {
	var timeValue = s_time.substr(0, 2) + ":" + s_time.substr(2, 2);
	return isShortTime(timeValue);
}
...
a_formats = {
  ...
  'shortTimeNoBreakSign': isShortTimeNoBreakSign
},
a_messages = [
