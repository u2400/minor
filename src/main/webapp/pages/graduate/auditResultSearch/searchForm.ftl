<table width="100%">
	<tr valign="top" style="font-size:8pt">
		<td style="text-align:text;text-valign:bottom;font-weight:bold" colspan="2"><img src="images/action/info.gif" align="top"/>&nbsp;学籍查询项</td>
	</tr>
	<tr>
		<td style="font-size:0px" colspan="2"><img src="images/action/keyline.gif" align="top" width="100%" height="2"/></td>
	</tr>
	...
	<tr>
  	...
  	<tr>
						     		<td>审核标准</td>
						     		<td>
							     		<select id="f_auditStandard" name="auditStandardId" style="${formElementWidth}">
									     	<#list auditStandardList?if_exists as auditStandard >
