...
<table class="frameTableStyle">
	<tr>
		...
		<td  align="center" class="infoTitle" style="height:22px;width:100px;background-color:${absenteeismColor};" class="padding"  >2&nbsp;旷课</td>
		...
		<td  width="10%" style="height:22px;width:200px;font-size:10pt" class="padding" onclick="onClose()" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)"><img src="images/close.gif" class="iconStyle" alt="<@bean.message key="action.close"/>" />&nbsp;<@bean.message key="action.close"/></td>
		<td  width="10%"/>
	</tr>
</table>
