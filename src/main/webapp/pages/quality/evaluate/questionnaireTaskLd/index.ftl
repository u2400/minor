...
<BODY LEFTMARGIN="0" TOPMARGIN="0">
  ...
  <table width="100%"  height="85%" class="frameTable">
   ...
   <table width="100%" class="searchTable" id="departListTable">
		 ...
		 <td><@htm.i18nSelect datas=courseTypeList?if_exists selected="" name="task.courseType.id" style="width:100px;"><option value="">...</option></@>
		 </td>
		 </tr>
		 <tr>
		 <td>开课院系</td>
		 <td>
		 <@htm.i18nSelect datas=departmentList?if_exists selected="" name="task.arrangeInfo.teachDepart.id" style="width:100px;"><option value="">...</option></@>
		 </td>
		 </tr>
		 <tr>
		 	<td>有无问卷</td>
		 	<td >
      	       <select name="questionnaireLdEstate" style="width:100px;">
  ...
  <table>  
	...
	var action="questionnaireTaskLd.do";
