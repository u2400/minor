...
<script>
   var bar = new ToolBar('backBar','领导问卷设置',null,true,true);
   ...
   <td valign="top" class="frameTable_view" width="20%" style="font-size:10pt">
	  ...
	  <tr>
       ...
       <tr>
         <td class="padding" id="defaultItem" onclick="info(this,'questionnaireLd.do?method=search')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"/>问卷信息
         </td>
       </tr>
       <tr>
         <td class="padding" onclick="info(this,'questionLd.do?method=search')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif"/>问题信息
         </td>
       </tr>
       <tr>
         <td class="padding" onclick="info(this,'questionType.do?method=search')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif"/>问题类别
         </td>
       </tr>
       <tr>
         <td class="padding" onclick="info(this,'optionGroup.do?method=search')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif"/>选项组
         </td>
       </tr>
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif"/>评价标准
         </td>
       </tr>
	  </table>
	<td>
