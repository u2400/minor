<table width="100%">
	<tr>
		<td align="left" valign="bottom" colspan="2"><img src="images/action/info.gif" align="top"/>&nbsp;<B>详细查询(模糊输入)</B></td>
	</tr>
	<tr>
	...
	<tr>
		<td>领导账号：</td>
		<td><input type="text" name="evaluateResult.user.name" value="${RequestParameters["evaluateResult.user.id"]?default('')}" style="width:100px" maxlength="50"/></td>
	</tr>
	<tr>
		<td>课程序号：</td>
