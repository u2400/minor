...
<table width="100%">
	...
	<tr>
		<td>教师工号：</td>
		<input type="hidden" name="_evaluateTeacher.teacher.code" value="教师工号"/>
	...
	<tr>
		<td>教师姓名：</td>
		<input type="hidden" name="_evaluateTeacher.teacher.name" value="教师姓名"/>
	...
	<tr>
		<td>课程代码：</td>
		<input type="hidden" name="_evaluateTeacher.course.code" value="课程代码"/>
	...
	<tr>
		<td>课程名称：</td>
		<input type="hidden" name="_evaluateTeacher.course.name" value="课程名称"/>
    ...
    <tr>
        <td>课程分类：</td>
		<input type="hidden" name="_evaluateTeacher.questionnaire.id" value=""/>
        <td><select name="evaluateTeacher.questionnaire.id" style="width:100px" value="${RequestParameters["evaluateTeacher.questionnaire.id"]?default("")}">
            <option value="">...</option>
    ...
    <tr>
        <td>所在院系：</td>
        <input type="hidden" name="_evaluateTeacher.department.id" value=""/>
        <td><@htm.i18nSelect datas=departments?sort_by("name") name="evaluateTeacher.department.id" selected=RequestParameters["evaluateTeacher.department.id"]?default("") maxlength="50" style="width:100px"><option value="">...</option></@></td>
    </tr>
    <tr>
        <td>教师职级：</td>
        <input type="hidden" name="_evaluateTeacher.titleLevel.id" value=""/>
        <td><@htm.i18nSelect datas=titleLevels?sort_by("name") name="evaluateTeacher.titleLevel.id" selected=RequestParameters["evaluateTeacher.titleLevel.id"]?default("") maxlength="50" style="width:100px"><option value="">...</option></@></td>
    </tr>
	<tr>
...
<table width="100%">
	<tr>
		<td align="left" valign="bottom" colspan="2"><img src="images/action/info.gif" align="top"/>&nbsp;<B>记录查询(模糊输入)</B></td>
	</tr>
	<tr>
		<td colspan="2" style="font-size:0px"><img src="images/action/keyline.gif" height="2" width="100%" align="top"></td>
	</tr>
