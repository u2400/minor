...
<body>
    ...
    <table class="frameTable_title">
        ...
        <form method="post" action="" name="actionForm">
            <input type="hidden" name="params" value="&teachCalendar.id=${calendar.id}"/>
    ...
    <script>
        ...
        function beforeOnClick() {
            if (calendarAction != "evaluateDetailStat.do?method=index") {
                calendarAction = "evaluateDetailStat.do?method=index";
            }
        }
        ...
        function search(searchFormFlag) {
            ...
            if (null != form["evaluateTeacher.department.id"].value) {
                form["_evaluateTeacher.department.id"].value = form["evaluateTeacher.department.id"].options[form["evaluateTeacher.department.id"].selectedIndex].text;
            }
            if (null != form["evaluateTeacher.titleLevel.id"].value) {
                form["_evaluateTeacher.titleLevel.id"].value = form["evaluateTeacher.titleLevel.id"].options[form["evaluateTeacher.titleLevel.id"].selectedIndex].text;
            }
            if (null != form["evaluateTeacher.questionnaire.id"].value) {
                form["_evaluateTeacher.questionnaire.id"].value = form["evaluateTeacher.questionnaire.id"].options[form["evaluateTeacher.questionnaire.id"].selectedIndex].text;
            }
            form.submit();
        }
