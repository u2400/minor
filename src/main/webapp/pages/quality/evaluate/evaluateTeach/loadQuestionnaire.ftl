	...
	<table id="tableName" align="center" class="listTable" width="100%">
		...
		<tr>
			<td colspan="4" align="center" class="darkColumn">
				...
				<input type="hidden" name="params" value="&calendarYear=${RequestParameters['calendarYear']}&calendarTerm=${RequestParameters['calendarTerm']}"/>
	...
	function doAction(form){
		var errors ="";
	 	...
	 	if(confirm("<@bean.message key="field.select.selectSubmit"/>")==true){
	    	...
	    	form.action="evaluateTeach.do?method=save";
