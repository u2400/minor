  ...
  <table id="bar" width="100%"></table>
   <table  class="frameTable_title">
      <tr>
       ...
       <td>|</td>
      <form name="evaluateForm" method="post" action="textEvaluationLd.do?method=index" action="" onsubmit="return false;">
	...
	<script language="javascript">
		function query(form){
			form.action="textEvaluationLd.do?method=search";
			form.target="displayFrame";
			form.submit();
		}
	   query(document.evaluateForm);
       var bar = new ToolBar('bar','领导意见汇总',null,true,true);
