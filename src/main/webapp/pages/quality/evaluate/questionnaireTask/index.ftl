  ...
  <table width="100%"  height="85%" class="frameTable">
   ...
   <table width="100%" class="searchTable" id="departListTable">
        <tr>
         ...
         <tr>
			<td>授课教师</td>
            <td><input type="text" name="teacherName" value="" maxlength="30" style="width:100px;"/></td>
			</tr>
			<tr>
            <td>问卷描述</td>
            <td><input type="text" name="task.questionnaire.description" value="" maxlength="30" style="width:100px;"/></td>
         </tr>
         <tr>
            <td>有无问卷</td>
		...
		<tr>
            <td>语言类型</td>
            <td><@htm.i18nSelect datas=teachLangTypes?if_exists selected="" name="task.requirement.teachLangType.id" style="width:100px;"><option value="">...</option></@></td>
         </tr>
