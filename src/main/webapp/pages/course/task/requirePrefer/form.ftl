   ...
   <table width="90%" align="center" class="formTable">
      <form name="requireForm" action="requirePrefer.do?method=saveRequirement" method="post" onsubmit="return false;">
	   ...
	   <tr>
 	     ...
 	     <td  colspan="3">
 	     <textarea name="require.referenceBooks" cols="40">${require.referenceBooks?if_exists}</textarea>
         </td>
       </tr>
	   <tr>
 	     <td class="title">&nbsp;<@bean.message key="attr.cases"/>：</td> 	     
 	     <td  colspan="3">
 	     	<textarea name="require.cases" cols="40">${require.cases?if_exists}</textarea>
         </td>
       </tr>
	   <tr>
 	     <td class="title">&nbsp;教学大纲：</td> 	     
 	     <td  colspan="3">
 	     	<textarea name="require.requireRemark" cols="40">${require.requireRemark?if_exists}</textarea>
         </td>
       </tr>
     </table>
    </td>
