     ...
     <table width="100%" border="0" align="center" class="listTable" id="taskInfoTable">
       ...
       <tr>
         ...
         <td class="brightStyle">
           <select name="task.arrangeInfo.teachDepart.id" style="width:155px">
             <#list teachDepartList?sort_by("code") as oneTeachDepart>                                                                                                <#--defaultMap在页面上定义-->
       ...
       <tr>
         ...
         <td class="brightStyle">
            ...
            <#list configTypeList as config>                                                                                  <#--defaultMap在页面上定义-->
       ...
       <tr>
         ...
         <td class="brightStyle">
           <input name="task.arrangeInfo.courseUnits" value="${task.course.credits?if_exists}"/>
         </td>
       </tr>
       <tr>
      ...
      <table width="100%" border="0"  cellpadding="0" cellspacing="1" align="center" id="tableId_0">
       ...
       <td class="infoTitle" style="height:22px;" colspan="7">
           <img src="images/action/info.gif"><B>教师</B>
           ...
           <select id="teacherId_0" name="teacherId_0" style="width:100px" length="10">
       ...
       <tr class="grayStyle" align="center">
         <td><input id="enrollTurnId_0" name="teacherId_0teachClassId_0.enrollTurn" maxlength="6" style="width:${formElementWidth}" value=""/></td>
         <td><select id="departmentId_0" name="teacherId_0teachClassId_0.depart.id" style="width:${formElementWidth}"><option value="${(defaultMap["teachClassDepart"]["id"])?default("")}">${(defaultMap["teachClassDepart"]["name"])?default("")}</option></select></td>
         <td><select id="specialityId_0" name="teacherId_0teachClassId_0.speciality.id" style="width:${formElementWidth}"><option value=""></option></select></td>
         <td><select id="specialityAspectId_0" name="teacherId_0teachClassId_0.aspect.id" onchange="setAdminClassList('teacherId_0','adminClassId_0')"style="width:${formElementWidth}"><option value=""></option></select></td>
         <td><select id="adminClassId_0" name="teacherId_0adminClassId_0" style="width:${formElementWidth}"><option value=""></option></select></td>
         <td><input id="planStdCountId_0" name="teacherId_0teachClassId_0.planStdCount" value="20" style="width:${formElementWidth}"/></td>
         <td><input id="teachClassNameId_0"name="teacherId_0teachClassId_0.name" maxLength="50" value="${task.teachClass.name}" style="width:${formElementWidth}"/></td>
        </tr>
     </table>
       </td>
       </tr>
