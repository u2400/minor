 ...
 <#include "/templates/back.ftl"/>
    <table class="infoTable" >
        ...
        <tr>
            ...
            <td class="content"><#if task.requirement.isGuaPai><@bean.message key="common.yes"/><#else><@bean.message key="common.no"/></#if></td>
        ...
        <tr>
            ...
            <td class="content"><#if task.arrangeInfo.weekCycle==1><@bean.message key="attr.continuedWeek"/><#elseif task.arrangeInfo.weekCycle==2><@bean.message key="attr.oddWeek"/><#elseif task.arrangeInfo.weekCycle==3><@bean.message key="attr.evenWeek"/><#else><@bean.message key="attr.randomWeek"/></#if></td>
            ...
            <td class="content"><#if task.arrangeInfo.isArrangeComplete><@bean.message key="common.yes"/><#else><@bean.message key="common.no"/></#if></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content"><#if task.electInfo.isElectable><@bean.message key="common.yes"/><#else><@bean.message key="common.no"/></#if></td>
            <td class="title"><@bean.message key="attr.isCancelable"/>:</td>
            <#if !task.electInfo.isElectable>
            <td class="content" colspan="3"><#if task.electInfo.isCancelable><@bean.message key="common.yes"/><#else><@bean.message key="common.no"/></#if></td>
            <#else>
            <td class="content" colspan="3"><#if task.electInfo.isCancelable><@bean.message key="common.yes"/><#else><@bean.message key="common.no"/></#if></td>
            </#if>
        </tr>
