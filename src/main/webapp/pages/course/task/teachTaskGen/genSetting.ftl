...
<#include "/templates/back.ftl"/> 
   <table width="95%" align="center" class="formTable">
       ...
       <tr>
         ...
         <td>
            <input name="params.removeGenerated" type="radio" value="1"/>删除已经生成的任务
            <input name="params.removeGenerated" type="radio" checked value="0"/>保留生成的任务
         </td>
       </tr>
        </#if>
       <tr>
       ...
       <tr>
         ...
         <td>&nbsp;指定要生成的课程代码(多个代码以逗号相隔):<input name="params.courseCodeSeq" value="${RequestParameters["params.courseCodeSeq"]?if_exists}" maxlength="200"/></td>
       </tr>
       <tr>
         ...
         <td>
            <table cellpadding="0" cellspacing="0" style="text-align:center">
                <tr>
                    ...
                    <input type="hidden" name="params.courseTypeIds" value="<#list courseTypes as courseType>${courseType.id},</#list>"/>
                </tr>
            </table>
         </td>
       </tr>
   ...
   function save(){
       ...
       if(getSelectId("params.removeGenerated") == "1" && !confirm("重新生成教学任务，将会删除已经生成的教学任务，确认重新生成吗?")) {
          return;
       }
       form.submit();
   }
