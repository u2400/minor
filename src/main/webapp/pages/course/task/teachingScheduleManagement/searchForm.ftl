<table width="100%">
    ...
    <tr>
        <td width="40%">课程序号：</td>
        <td><input type="text" name="task.seqNo" value="" maxlength="30" style="width:100%"/></td>
    </tr>
    <tr>
        <td width="40%">课程代码：</td>
    ...
    <tr>
        <td>课程名称：</td>
        <td><input type="text" name="task.course.name" value="" maxlength="30" style="width:100%"/></td>
    </tr>
    <tr>
        <td>绑定文件：</td>
        <td><input type="text" name="schedule.name" value="" maxlength="30" style="width:100%"/></td>
    </tr>
    <tr>
        <td>是否绑定：</td>
        <td>
