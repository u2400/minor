   ...
   <td valign="top" class="frameTable_view" width="20%" style="font-size:10pt">
	  ...
	  <tr>
       ...
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom" ><@msg.message key="entity.press"/>
         </td>
       </tr>
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif"><@msg.message key="entity.textbookAwardLevel"/>
         </td>
       </tr>
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif"><@msg.message key="entity.courseType"/>
         </td>
       </tr>
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif"><@msg.message key="attr.teachDepart"/>
         </td>
       </tr>
       <tr>
         <td class="padding" onclick="stat(this,'textBook','教材名称')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif">教材名称
         </td>
       </tr>
	    <tr>
	      <td  class="infoTitle" align="left" valign="bottom">
       ...
       <tr>
         <td class="padding" onclick="statCheck(this,'textBook','教材名称')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif">教材名称
         </td>
       </tr>
        <tr>
            <td class="infoTitle" style="text-align:left;vertical-align:bottom;font-weight:bold"><img src="images/action/info.gif" align="top"/>&nbsp;汇总统计</td>
        </tr>
        <tr>
            <td colspan="8" style="font-size:0px"><img src="images/action/keyline.gif" height="2" width="100%" align="top"/></td>
        </tr>
        <tr>
            <td class="padding" onclick="collectStat(this,'currCalendarCollect','本学期汇总')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)"><image src="images/action/list.gif"/>本学期汇总</td>
        </tr>
	  </table>
	<td>
	<td valign="top">
...
<script>
   ...
   function collectStat(td,kind,kindName){
      clearSelected(viewTables,td);
      setSelectedRow(viewTables,td);
      form.action="bookRequireStat.do?method=" + kind;
      form.target = "statFrame";
      form.submit();
   }
</script>
