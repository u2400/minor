...
<form name="scopeForm" method="post" action ="electScope.do?method=save&hold=true" onsubmit="return false;">
 ...
 <table style="width:100%" border="0" class="listTable" id="scopeTable">
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:150px"  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="entity.studentType"/> <@bean.message key="common.list"/></B>
	      </td>
	      <td></td>
	      <td  class="padding" valign="bottom" onclick="javascript:setSelectOption(stdTypeListSelect)" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
	       <img src="images/action/save.gif" align="top"/><B><@bean.message key="action.confirm"/></B>
	      </td>
      </tr>
      <tr>
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:150px;border:0px;solid #000000;  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="entity.college"/> <@bean.message key="common.list"/></B>
	      </td>
	      <td></td>
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:150px"  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="entity.speciality"/> <@bean.message key="common.list"/></B>
	      </td>
	      <td></td>
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:200px"  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="entity.specialityAspect"/> <@bean.message key="common.list"/></B>
	      </td>
	      <td></td>
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:150px"  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="entity.adminClass"/> <@bean.message key="common.list"/></B>
	      </td>
	      <td></td>
	...
	<table width="100%" border="0">
     <tr>
	      <td  class="padding" style="height:22px;width:150px"  align="left" valign="bottom">
	       <img src="images/action/info.gif" align="top"/><B><@bean.message key="attr.stdNoSegement"/></B>
	      </td>
      </tr>
      <tr>
	      <td  colspan="4" style="font-size:0px">
