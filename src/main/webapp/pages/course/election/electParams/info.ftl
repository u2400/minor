...
<body>
	...
	<#include "/templates/back.ftl"/>
     ...
     <tr>
       ...
       <tr>
            <td class="title">&nbsp;允许非当轮可退课程类别：</td>
            <td colspan="3"><#list electParams.notCurrentCourseTypes as courseType>${courseType.name}<#if courseType_has_next>，</#if></#list></td>
       </tr>
       <tr>
	   	 <td class="darkColumn"  colspan="4">&nbsp;<@bean.message key="entity.electDateTime"/>：</td>
       </tr>
       <tr>
	   	 <td class="title"  id="f_startDate">&nbsp;开始时间(选课)：</td>
	     <td>${electParams.startAt?string("yyyy-MM-dd HH:mm:ss")}<br/>(${electParams.electStartAt?string("yyyy-MM-dd HH:mm:ss")})</td>
	   	 <td class="title"  id="f_startTime">&nbsp;结束时间(选课)：</td>
	     <td>${(electParams.endAt?string("yyyy-MM-dd HH:mm:ss"))}<br/>(${electParams.electEndAt?string("yyyy-MM-dd HH:mm:ss")})</td>
       </tr>
       <tr>
       ...
       <tr>
	   	 <td class="title" id="f_notice">&nbsp;选课协议：</td>	
	     <td  colspan="3">${(electParams.notice.notice)?if_exists}</td>
       </tr>
  </table>
 </body>
