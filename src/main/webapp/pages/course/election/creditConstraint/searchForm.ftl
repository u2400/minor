   <div style="display: block;" id="view0">
	  ...
	  <form name="stdCreditForm" method="post" action="creditConstraint.do" onsubmit="return false;">
	    ...
	    <tr> 
	     ...
	     <td><input name="creditConstraint.std.code" type="text" value="" style="width:100px"/></td>
	    </tr>
	    <tr>
	     <td class="infoTitle"  ><@msg.message key="attr.personName"/>:</td>
	     <td><input name="creditConstraint.std.name" type="text" value="" style="width:100px"/></td>
	    </tr>
	    <tr>
	     <td class="infoTitle"  ><@bean.message key="attr.enrollTurn"/>:</td>
	     <td><input name="creditConstraint.std.enrollYear" type="text" value="" style="width:100px"/></td>
	    </tr>
	    <tr>
        ...
        <tr>
          <td class="infoTitle">入学方式:</td>
          <td align="left">
            <select name="creditConstraint.std.studentStatusInfo.enrollMode.id" style="width:100px;">
             <option value="">...</option>
             <#list enrollModes as mode>
        ...
        <tr>
	      ...
	      <td align="left">
	        <input name="maxFrom" value="" style="width:45px">-<input name="maxTo" value="" style="width:45px">
	      </td>
        </tr>
        <tr>
	      <td class="infoTitle">已选范围:</td>
	      <td align="left">
	        <input name="electedFrom" value="" style="width:45px">-<input name="electedTo" value="" style="width:45px">
	      </td>
        </tr>
        <tr>
	      <td class="infoTitle">奖励范围:</td>
	      <td align="left">
	        <input name="awardFrom" value="" style="width:45px">-<input name="awardTo" value="" style="width:45px">
	      </td>
        </tr>
        <tr>
	      <td class="infoTitle">绩点范围:</td>
	      <td align="left">
	        <input name="gpaFrom" value="" style="width:45px">-<input name="gpaTo" value="" style="width:45px">
	      </td>
        </tr>
        <tr>
            <td id="f_studentStatus">学籍状态:</td>
            <td>
                <select name="creditConstraint.std.state.id" style="width:100px;">
                    <option value="">...</option>
                    <#list studentStates as studentState>
                    <option value="${studentState.id}"<#if RequestParameters["courseGrade.std.state.id"]?default("1")==studentState.id?string> selected</#if>/><@i18nName studentState/></option>
                    </#list>
                </select>
            </td>
        </tr>
    ...
    <div style="display: none;" id="view1">
	  ...
	  <form name="majorCreditForm" method="post" action="creditConstraint.do" onsubmit="return false;">
        ...
        <tr>
	      <td class="infoTitle">上限范围:</td>
	      <td align="left">
	        <input name="creditConstraintMaxFrom" value="" style="width:45px" maxlength="3"/>-<input name="creditConstraintMaxTo" value="" style="width:45px" maxlength="3"/>
	      </td>
        </tr>
	    <tr align="center">
	     <td colspan="2">
