<#include "/templates/head.ftl"/>
    ...
    <script>
        ...
        function initData() {
            form["switch.isArrangeAddress"].value = "${((arrangeSwitch.isArrangeAddress)!false)?string("1", "0")}";
            form["switch.isPublished"].value = "${((arrangeSwitch.isPublished)!false)?string("1", "0")}";
        }
