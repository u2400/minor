    ...
    <#list courseTable.tasksGroups?if_exists as group>
     ...
     <tr align="center" onmouseover="swapOverTR(this,this.className)" onmouseout="swapOutTR(this)" >
      ...
      <#if task.requirement.isGuaPai == true>
	      ...
	      <td colspan="3">
	       <a href="teachTaskSearch.do?method=courseInfo&id=${task.course.id}&type=Course" target="_blank" title="<@msg.message key="common.displayDetailCourse"/>"><@i18nName task.course/></a>
	      </td>
