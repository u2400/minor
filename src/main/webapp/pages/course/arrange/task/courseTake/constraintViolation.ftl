<#include "/templates/head.ftl"/>
 ...
 <@table.table id="listTable" width="100%" sortable="true">
	  <@table.thead>
	   ...
	   <@table.sortTd id="courseTake.task.electInfo.maxStdCount" text="人数上限"/>
	   <@table.td text="真实容量"/>
	  ...
	  <@table.tbody datas=tasks;task>
	    ...
	    <#assign roomCapacityCount = 0/>
	    <#list task.arrangeInfo.activities as activity>
            <#assign roomCapacityCount = roomCapacityCount + activity.room.capacity/>
	    </#list>
	    <td>${roomCapacityCount}</td>
