<table width="100%">
    <tr class="infoTitle" valign="top" style="font-size:10pt;font-weight:bold;font-family:宋体">
        <td class="infoTitle" align="left" valign="bottom"><img src="images/action/info.gif" align="top"/>&nbsp;归属院系/任务数</td>
    </tr>
    <tr>
        <td style="font-size:0pt"><img src="images/action/keyline.gif" height="2" width="100%" align="top"/></td>
    </tr>
</table>
