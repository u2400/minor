...
<table id="taskGroupInfoBar"></table>
   ...
   var bar = new ToolBar('taskGroupInfoBar','体育课分组详细信息',null,true,true);
   ...
   function addTeachersSetting() {
    form.action = "englishGroup.do?method=addTeachersSetting";
    form.submit();
   }
   ...
   function addAdminClassesSetting() {
    form.action = "englishGroup.do?method=addAdminClassesSetting";
    form.submit();
   }
   </#if>
  </script>
