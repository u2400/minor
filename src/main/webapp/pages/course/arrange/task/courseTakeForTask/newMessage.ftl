...
<script language="javascript" type="text/javascript" src="scripts/fckeditor/fckeditor.js"></script>
<script language="javascript" type="text/javascript" src="scripts/fckeditor/fckTextArea.js"></script>
...
<table id="backBar"></table>
     <table width="100%">       
		   ...
		   <tr>
                ...
                <#assign stdIds = stdIds + student.id + ","/>
		   	   </#list>
		   	  	<input id="receiptorIds" type="hidden" name="receiptorIds" value="${stdIds?default("")}"/>
		   	  	<textarea id="receiptorNames" name="receiptorNames" rows="2" cols="60" readonly style="font-size:10pt"><#list students as student>${student.name},</#list></textarea>
