	  ...
	  <table class="searchTable" onkeypress="DWRUtil.onReturn(event, search)">
        ...
        <tr>
            <td>学籍状态:</td>
            <td>
                <select name="courseTake.student.state.id" style="width:100px">
                    <option value="" selected>全部</option>
                    <#list studentStates as state>
        ...
        <tr>
            <td>入学方式:</td>
            <td>
                <select name="courseTake.student.studentStatusInfo.enrollMode.id" style="width:100px">
                    <option value="" selected>全部</option>
                    <#list enrollModes as enrollMode>
                    <option value="${enrollMode.id}">${enrollMode.name}</option>
                    </#list>
                </select>
            </td>
        </tr>
