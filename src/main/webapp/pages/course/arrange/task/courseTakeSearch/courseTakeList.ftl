<@table.table id="listTable" sortable="true" width="100%">
	  <@table.thead>
	   ...
	   <@table.td text="修读类别" width="8%"/>
		<@table.td id="courseTake.task.course.studentState" name="entity.studentState"/>
	  </@>
	  <@table.tbody datas=courseTakes;take>
	    ...
	    <td><A href="javascript:courseInfo('id', ${take.task.course.id})">${take.task.course.code}</A></td>
