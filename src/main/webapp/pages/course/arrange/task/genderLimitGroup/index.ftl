...
<BODY>
    ...
    <table class="frameTable_title">
      ...
      <form name="taskGroupForm" method="post" action="genderLimitGroup.do?method=index" onsubmit="return false;">
  ...
  <table width="100%" class="frameTable" height="85%">
    <tr>
     <td class="frameTable_view" style="width:17%">
	     <iframe src="genderLimitGroup.do?method=groupList&calendar.id=${calendar.id}&displayFirst=1&taskGroup.id=${taskGroupId?if_exists}"
 ...
 <script>
   ...
   function newGroup(){
       ...
       form.action="genderLimitGroup.do?method=newGroup";
   ...
   function getGroupList(){
     ...
     taskGroupListFrame.window.location="genderLimitGroup.do?method=groupList&calendar.id=${calendar.id}";
   }
   ...
   function refreshGroupList(){
       ...
       if(displayFirst) {
         taskGroupListFrame.window.location="genderLimitGroup.do?method=groupList&calendar.id="+ calendarId+"&displayFirst=1";
       } else {
         taskGroupListFrame.window.location="genderLimitGroup.do?method=groupList&calendar.id="+ calendarId+"&displayFirst=0";
       }
   }
   
   function activityReport() {
    var oForm = document.taskGroupForm;
    oForm.action = "genderLimitGroup.do?method=activityReport";
    oForm.target = "_blank";
    oForm.submit();
   }
 </script>
