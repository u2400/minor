...
<body  LEFTMARGIN="0" TOPMARGIN="0">
	...
	function query(pageNo,pageSize){
	    ...
	    form.action="genderLimitGroup.do?method=lonelyTaskList";
    ...
    function add(quickAdd){
       	...
       	var form = document.taskListForm;
       	if (quickAdd == 1) {
          	form.action = "genderLimitGroup.do?method=addTasks&quickAdd=1&taskIds=" + taskIds;
       	} else {
          	form.action = "genderLimitGroup.do?method=addTaskOptions&taskIds=" + taskIds;  
       	}
       	form.submit();
    }
    function getIds(){
