...
<body>
    ...
    <script>
        ...
        <#if "null" == RequestParameters["adjust.isFinalOk"] && "1" == RequestParameters["adjust.isPassed"]>
        bar.addItem("终审", "audit()");
        </#if>
        <#if RequestParameters["adjust.isPassed"]?default("null") == "null" && RequestParameters["adjust.isFinalOk"]?default("null") == "null">
        ...
        function audit() {
            ...
            form.action = "adjustArrangeManage.do?method=auditEdit";
            form.target = "_self";
        ...
        function info() {
            ...
            form.action = "adjustArrangeManage.do?method=info";
            form.target = "_self";
            form["adjustId"].value = adjustId;
            form.submit();
        }
