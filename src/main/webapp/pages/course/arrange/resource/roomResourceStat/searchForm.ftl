            <table border="0">
                ...
                <tr>
                    <td class="infoTitle">显示方式:</td>
                    <td align="left"><input type="radio" name="displayStyle" value="simple" checked/>简单&nbsp;<input type="radio" name="displayStyle" value="detail"/>详细</td>
                </tr>
            </table>
