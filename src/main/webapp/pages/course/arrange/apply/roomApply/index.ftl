...
<BODY LEFTMARGIN="0" TOPMARGIN="0" >
    ...
    <table width="100%" class="frameTable" height="90%">
        ...
        <tr>
                ...
                <table width="100%" id ="menuTable" style="font-size:10pt">
                    ...
                    <tr>
                        <td class="padding" id="item1" onclick="selectFrame(this, 'displayFrame', 'pricesReview')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
                            &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"/>价目浏览
                        </td>
                    </tr>
                    <tr>
                        <td class="padding" id="item11" onclick="selectFrame(this, 'displayFrame', 'pricesReview369')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
                            &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"/>价目浏览(369校区)
                        </td>
                    </tr>
                    -->
                    <tr>
                        <td class="padding" id="item4" onclick="selectFrame(this, 'displayFrame', 'freeRoomHome')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
                            &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"/>查看空闲教室
                        </td>
                    </tr>
                    <tr>
                        <td class="padding" id="item2" onclick="selectFrame(this, 'displayFrame',  'myApplied')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
                            &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"/>我已申请
                        </td>
                    </tr>
                    <tr height="80%">
                        <td>&nbsp;&nbsp;</td>
            ...
            <td valign="top">
                <iframe id="displayFrame" name="displayFrame" src="#" marginwidth="0" marginheight="0"  width="100%" style="height:100%" frameborder="0" scrolling="no"></iframe>
            </td>
        </tr>
    </table>
    <script>
        ...
        document.getElementById("item${RequestParameters["selectIndex"]?default("4")}").onclick();
