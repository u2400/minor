<table width="100%" id="menuTable" onkeypress="DWRUtil.onReturn(event, search)">
    ...
    <tr>
        <td colspan="2" id="f_Time">
         <fieldset align=center>
         <legend>申请时间</legend>
         从:<input type="text" name="applyAt" onfocus="calendar()" maxlength="10" style="width:100px"/>
        到： <input type="text" name="applyAt" onfocus="calendar()" maxlength="10" style="width:100px"/>
         </fieldset>
        </td>
    </tr>
    <tr>
