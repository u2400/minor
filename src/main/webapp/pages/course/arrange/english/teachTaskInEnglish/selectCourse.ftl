...
<BODY LEFTMARGIN="0" TOPMARGIN="0" style="overflow-x:hidden;overflow-y:hidden;">
  ...
  <script>
     <#assign labelInfo><@bean.message key="info.task.add.selectCourse"/> [<@i18nName studentType/>]</B></#assign>
  ...
  <table class="listTable" width="100%">
    ...
    <input type="hidden" name="course.extInfo.courseType.isPractice" value="${RequestParameters["course.extInfo.courseType.isPractice"]?if_exists}"/>
