    ...
    <td>
     <table class="listTable" style="font-size:12px">
      ...
      <tr>
       ...
       <td align="left">&nbsp;${courseCount}&nbsp;<@i18nName planCourse.course/><#if planCourse.course.id==5780||planCourse.course.id==5781||planCourse.course.id==5782||planCourse.course.id==5783>&nbsp;*&nbsp;</#if></td>
      ...
      <tr>
       ...
       <td><#if weekHour!="0"><p align="center">${weekHour}</p><#else>&nbsp;</#if> 
