...
<body>
 ...
 <#include "../taskListTable.ftl"/>
  ...
  <script> 
     ...
     gradeStateMenu.addItem("批量百分比设置", "editBatchPercent()", "update.gif");
    ...
    function editBatchPercent() {
        submitId(document.actionForm, "taskId", true, "courseGrade.do?method=editBatchPercent", "要设置教学任务中可能有成绩，要进入批量修改吗？");
    }
  </script>
</body> 
