<table width="100%">
	<tr>
		<td align="left" valign="bottom"><img src="images/action/info.gif" align="top"/>&nbsp;<B>详细查询(模糊输入)</B></td>
	</tr>
	<tr>
...
<table width="100%" onkeypress="DWRUtil.onReturn(event, search)">
	...
	<tr>
         ...
         <td>
             <select name="courseGrade.std.inSchool" style="width:100px">
	...
	<tr>
		...
		<td><select name="courseGrade.courseType.id" style="width:100px" value=" value="${RequestParameters["task.courseType.id"]?if_exists}"">
