<#include "/templates/head.ftl"/>
 ...
 <table  class="frameTable_title">
    <tr>
        ...
        <td>|</td>
      <form name="calendarForm" target="classListFrame" method="post" action="moralGrade.do?method=index" onsubmit="return false;">
...
<script>
    ...
    bar.addItem("录入开关","inputGradeSwitch()");
    bar.addHelp("<@msg.message key="action.help"/>");
    search();
    function inputGradeSwitch(){
       window.open("moralGradeInputSwitch.do");
    }
</script> 
 </body>   
