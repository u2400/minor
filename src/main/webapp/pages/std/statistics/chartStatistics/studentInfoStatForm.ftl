...
<script>
   ...
   function stat(td,kind){
      ...
      if (td.id == "defaultTd") {
          isHidden = false;
	      submit${formName}();
	      setTimeout("hiddenSearchBar()", 4000);
      } else {
	      submit${formName}();
      }
   }
