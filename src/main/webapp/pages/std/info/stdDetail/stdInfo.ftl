 ...
 <table  class="infoTable" style="width:100%">
	 ...
	 <script language="javascript">
	 	function refreshPhoto(){
	 	   $('studentPhoto').src='photoByStudent.do?method=download';
	 	}
	 </script>
   	<tr>
 		...
 		<td align="center" rowspan="6" width="120px" colspan="2">
 	       <img id="studentPhoto" src="photoByStudent.do?method=download" 
   	...
   	<tr>
     	<td class="title" cowspan="2">财务帐号：</td>
     	<td style="word-warp:break-word;word-break:break-all" cowspan="2">${std.financialAccount?if_exists}</td>
   	</tr>
 </table>
 <script>
