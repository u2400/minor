  ...
  <table width='100%' class="searchTable" onkeypress="DWRUtil.onReturn(event, search)">
       ...
       <td class="infoTitle">审核标准:</td>
    	...
    	<tr>
         ...
         <td class="infoTitle">学籍有效性:</td>
	     <td>
            <select name="isActive" style="width:100px">
        ...
        <tr>
            <td class="infoTitle">学位状态:</td>
            <td>
                <select name="degreeState" style="width:100px">
                    <option value="" selected>...</value>
                    <option value="1">毕业+有学位</value>
                    <option value="2">毕业</value>
                    <option value="3">结业</value>
                    <option value="4">未毕业</value>
                </select>
            </td>
        </tr>
	    <tr align="center">
