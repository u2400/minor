...
<body>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="padding: 0px; border-spacing: 0px">
        ...
        <th style="color: blue;background-color:Azure">学生成绩</th>
        <tr valign="top">
            <td style="color: blue" style="padding: 0px; border-spacing: 0px">
                <#list calendars as calendar>
                    <#if (calendarGradeMap[calendar.id?string]?default(0)?int > 0)>
                <table width="100%">
                ...
                <@table.table width="100%" id="courseGradeList" + calendar.id>
                   <@table.thead>
                   ...
                   <#list courseGrades as grade>
                       <#if grade.calendar.id == calendar.id>
