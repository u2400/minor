...
<table id="myBar" width="100%"></table>
   ...
   <#if applies?size==0> 您选择的申请已经经学校审核<#else>
    ...
    <@table.tbody datas=applies;apply>
     ...
     <table  width="90%" align="center" class="formTable">
       ...
       <tr>
          ...
          <td>
          <textarea  rows="5" cols="80"  name="collegeOpinion"></textarea>
          </td>
       </tr>
   ...
   function save(form){
	    var a_fields = {
	         ...
	         'collegeOpinion':{'l':'审核意见', 'r':true, 't':'f_opinion',mx:500}
	     };
	     var v = new validator(form , a_fields, null);
	     if (v.exec()) {
	        form.action="bursaryCollege.do?method=batchApprove"
	        form.target = "_self";
	        form.submit();
	     }
     }
