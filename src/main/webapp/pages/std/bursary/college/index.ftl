...
<BODY> 
    ...
    <table class="frameTable_title">
     <tr>
       ...
       <td>|</td>
       <form name="bursaryForm" target="bursaryListFrame" method="post" action="bursaryCollege.do?method=index" onsubmit="return false;">
	...
	<script>
		var bar=new ToolBar("bursaryBar","助学金申请审核——院系",null,true,true);
