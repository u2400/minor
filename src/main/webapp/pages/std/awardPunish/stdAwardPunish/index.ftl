   ...
   <td valign="top" class="frameTable_view" width="20%" style="font-size:10pt">
	  ...
	  <tr>
       ...
       <tr>
         ...
         &nbsp;&nbsp;<image src="images/action/list.gif" align="bottom"><@msg.message key="std.awardsPunishs.personal.rewards"/>
         </td>
       </tr>
       <tr>
         <td class="padding"  onclick="info(this,'punish')"  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="images/action/list.gif"><@msg.message key="std.awardsPunishs.personal.punishments"/>
         </td>
       </tr>
	  </table>
	<td>
