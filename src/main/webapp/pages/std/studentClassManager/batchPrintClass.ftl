    ...
    <br>
	 ...
	 <table class="printTableStyle"  width="100%"  >
	   ...
	   <tr class="brightStyle">
	     ...
	     <td><@i18nName stds[i+passNo]/><#if !stds[i+passNo].inSchool || !stds[i+passNo].active><font color="red">（${stds[i+passNo].state.name}）</font></#if></td>
	     ...
	     <td><@i18nName stds[i+pagePrintRow+passNo]?if_exists/><#if !stds[i+pagePrintRow+passNo].inSchool || !stds[i+pagePrintRow+passNo].active><font color="red">（${stds[i+pagePrintRow+passNo].state.name}）</font></#if></td>
