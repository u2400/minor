	   ...
	   <tr>
	     ...
	     <td class="brightStyle">
	      <input type="text" name="statusInfo.examNumber" maxlength="25" value="${examNumber?if_exists}"/>
	     </td>
	   </tr>
	   <tr>
	     <td class="grayStyle" width="25%" id="f_examNumber">&nbsp;考生号：</td>
	     <td class="brightStyle">
	      <input type="text" name="statusInfo.examineeNumber" maxlength="25" value="${(result.student.studentStatusInfo.examineeNumber)?if_exists}"/>
	     </td>
	   </tr>