...
<script>
    ...
    var extendMenu1=bar.addMenu("打印名单（有效）","printClass(0);","print.gif");
    extendMenu1.addItem("打印名单（全部）", "printClass(1)", "print.gif");
...
<script>
    ...
    function printClass(isAll){
        ...
        form.action = "adminClassManager.do?method=printClass";
        form["ids"].value = ids;
        form["isAll"].value = isAll;
        form.submit();
    }
    function getIds(){
