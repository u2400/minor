			...
			<td  style="width:160px" class="frameTable_view" valign="top">
				<table width="100%" class="searchTable" id="menuTable">
				    ...
				    <tr>
       				...
       				<tr>
         				<td class="padding" id="defaultItem1" onclick="detail(this, 'openInfo')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">&nbsp;&nbsp;<image src="images/action/list.gif" align="bottom">申请论文开题</td>
       				</tr>
       				<tr>
         				<td class="padding" id="defaultItem2" onclick="detail(this, 'reportInfo')" onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">&nbsp;&nbsp;<image src="images/action/list.gif" align="bottom">记录开题结果</td>
       				</tr>
				</table>
				</form>
			</td>
