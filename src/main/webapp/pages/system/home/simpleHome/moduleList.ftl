...
<link href="css/dynaTree.css" type="text/css" rel="stylesheet">
  ...
  <tr>
   <td>
	  <SCRIPT language="javascript">
		...
		menuTree.iconPath = '';
		menuTree.iconEmpty = 'images/tree/empty.gif';
		menuTree.iconPlus = 'images/tree/plus.gif';
		menuTree.iconPlus1 = 'images/tree/plus.gif';
		menuTree.iconPlus2 = 'images/tree/plus.gif';
		menuTree.iconMinus = 'images/tree/minus.gif';
		menuTree.iconMinus1 = 'images/tree/minus.gif';
		menuTree.iconMinus2 = 'images/tree/minus.gif';
		menuTree.iconLine1 = 'images/tree/line.gif';
		menuTree.iconLine2 = 'images/tree/line.gif';
		menuTree.iconLine3 = 'images/tree/line.gif';
		menuTree.iconItem = 'images/tree/sanjiao.gif';
