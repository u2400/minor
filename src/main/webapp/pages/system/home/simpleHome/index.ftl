...
#BakcGroup_image_td {F
  ...
  background-image: url(themes/simple/images/bgpic.bmp);
}
</style>
<body style="overflow-y:hidden;">
<table width="100%"  style="width:100%;height:78px" border="0" cellpadding="0" cellspacing="0" id="logoTable" style="" >
  <tr>
   <td width="995" ALIGN="right" VALIGN="bottom" width="521" BACKGROUND="themes/simple/images/head.jpg">&nbsp;</td>
   <td width="50%" ALIGN="right" VALIGN="bottom" BACKGROUND="themes/simple/images/000003.gif">
     ...
     <tr>
       ...
       <td align="right" valign="top" height="100%">
        ...
        <td align="right" valign="top" >
         <img src="themes/simple/images/modifyPassword.jpg" style="cursor:pointer;" onClick="changePassword()" alt="修改密码<#--<@bean.message key="field.user.modifyPassword"/>-->"/>&nbsp;
         <img src="themes/simple/images/goHome.jpg" style="cursor:pointer;" onClick="home()" alt="返回主页<#--<@bean.message key="field.user.backHome"/>-->"/>&nbsp;
         <img src="themes/simple/images/logout.jpg" style="cursor:pointer;" onClick="logout()" alt="退出<#--<@bean.message key="field.user.loginOut"/>-->" />
       </td>
     </tr>
    </table>
   </td>
...
<table id="mainTable" style="width:100%;height:84.5%" cellpadding="0" cellspacing="0" border="0">
 <tr>
  <td width="100%" colspan="3" VALIGN="TOP" height="16" id="BakcGroup_image_td" align="left"
   style="background-image: url(themes/simple/images/bgpic.bmp);">
 ...
 <tr>
    <td width="100%" colspan="3" bgcolor="#e1e6e9" align="center"><img src="themes/simple/images/up.jpg" name="imgup" onmousemove="style.cursor='hand';" onclick="verticalSwitch()"/></td>
 </tr>
 <tr>
   ...
   <td width="0%" height="100%" bgcolor="#e1e6e9" style="cursor:w-resize;">
	   <a onClick="horizontalSwitch('left_tag')">
	      <img id="left_tag" style="cursor:hand" src="themes/simple/images/left.jpg" border="0" >
	   </a>
    </td>
