...
<link href="themes/default/css/menu.css" rel="stylesheet" type="text/css">
<style>
#BakcGroup_image_td {
...
<table width="100%"  style="width:100%;height:95px" border="0" cellpadding="0" cellspacing="0" id="logoTable" style="" >
  <tr>
   <td width="995" ALIGN="right" VALIGN="bottom" BACKGROUND="themes/default/images/head.jpg">
     ...
     <tr>
       ...
       <td align="right" valign="top" height="100%">
        ...
        <td align="right" valign="top" >
         <img src="themes/default/images/modifyPassword.jpg" style="cursor:pointer;" onClick="changePassword()" alt="修改密码<#--<@bean.message key="field.user.modifyPassword"/>-->"/>&nbsp;
         <img src="themes/default/images/goHome.jpg" style="cursor:pointer;" onClick="home()" alt="返回主页<#--<@bean.message key="field.user.backHome"/>-->"/>&nbsp;
         <img src="themes/default/images/logout.jpg" style="cursor:pointer;" onClick="logout()" alt="退出<#--<@bean.message key="field.user.loginOut"/>-->" />
       </td>
     </tr>
     <tr>
 ...
 <tr>
   ...
   <td width="0%" height="100%" bgcolor="#ffffff" style="cursor:w-resize;">
	   <a onClick="horizontalSwitch('left_tag')">
	      <img id="left_tag" style="cursor:hand" src="themes/default/images/left.jpg" border="0" >
	   </a>
    </td>
