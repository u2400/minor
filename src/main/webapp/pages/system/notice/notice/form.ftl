...
<table width="100%"  class="listTable" >
   ...
   <tr class="darkColumn">
     ...
     [是否置顶显示<input type="hidden" name="notice.isUp" value="<#if notice.isUp?default(false)==true>true<#else>false</#if>"/>
	        <input name="isUp" type="checkbox" onchange="this.form['notice.isUp'].value = this.checked"<#if notice.isUp?if_exists==true> checked</#if>/>]</td>
   </tr>
   <tr>
