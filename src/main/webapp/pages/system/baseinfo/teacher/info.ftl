...
<body>
    ...
    <table width="99%" align="center" class="infoTable">
        ...
        <tr>
            ...
            <td>${(teacher.birthday?string("yyyy-MM-dd"))?default(" ")}</td>
            <td class="title">视频:</td>
            <td><#if teacher.videoName?exists && teacher.videoName != ""><a href="teacher.do?method=download&teacherId=${teacher.id}">是</a><#else>否</#if></td>
        </tr>
        <tr>
