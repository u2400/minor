 <table width="90%"  align="center" class="formTable">
       ...
       <tr>
         ...
         <td><input type="file" name="video" style="width:150px;"/>
         <#if (teacher.videoName)?exists && "" != teacher.videoName>
         <input id="_isRemoveInVideo" type="checkbox" value="1" onclick="isRemoveInVideo_onclick(this)"/>
         <label for="_isRemoveInVideo">是否删除</label>
         <input type="hidden" name="isRemoveInVideo" value=""/>
         </#if>
         </td>
       </tr>
       </div>
	 ...
	 function autoGen(){
	  ...
	  function isRemoveInVideo_onclick(thisObj) {
	   thisObj.form["video"].value = thisObj.checked ? "" : thisObj.form["video"].value;
	   thisObj.form["video"].disabled = thisObj.checked;
	   thisObj.form["isRemoveInVideo"].value = thisObj.checked ? thisObj.value : "";
	  }
	</script>