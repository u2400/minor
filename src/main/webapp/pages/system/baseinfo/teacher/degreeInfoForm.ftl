 <table  width="90%" align="center" class="formTable">
   ...
   <tr>
     ...
     <td>
      <@htm.i18nSelect name="teacher.degreeInfo.graduateSchool.id" datas=schoolList selected=(teacher.degreeInfo.graduateSchool.id)?default("")?string style="width:100%">
       <option value=""><@msg.message key="common.selectPlease"/></option>
      </@>
     </td>
     <td class="title">职称等级:</td>
     <td><@htm.i18nSelect name="teacher.titleLevel.id" datas=titleLevelList selected=(teacher.titleLevel.id)?default("")?string>
       <option value=""><@msg.message key="common.selectPlease"/></option>
      </@></td>
   </tr>
   <tr>
