...
<body>
    ...
    <table width="99%" align="center" class="infoTable">
        ...
        <tr>
            ...
            <td><@i18nName (teacher.degreeInfo.graduateSchool)?if_exists/></td>
            <td class="title">视频:</td>
            <td><#if teacher.videoName?exists && teacher.videoName != ""><a href="?method=download&teacherId=${teacher.id}">${teacher.videoName}</a><#else>暂无</#if></td>
        </tr>
        <tr>
