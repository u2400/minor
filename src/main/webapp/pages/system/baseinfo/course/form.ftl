...
<#include "/templates/back.ftl"/> 
  <table width="90%" align="center" class="formTable">
    ...
    <tr>
      ...
      <td><input type="text" name="course.name" value="${course.name?if_exists}" maxLength="100"></td>
    </tr>
    <tr>
  ...
  <script language="javascript" > 
    ...
    function save(form,params){
         ...
         'course.name':{'l':'<@msg.message key="attr.infoname"/>', 'r':true, 't':'f_name','mx':100},
         ...
         'course.engName':{'l':'<@msg.message key="attr.engName"/>', 'r':false, 't':'f_engName','mx':50},
