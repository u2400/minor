...
<body>
   <TABLE WIDTH="60%" align="center" class="formTable">
    ...
    <tr> 
     ...
     <td class="text1"><input type="password" name="password"  maxLength="64"/><input type="hidden" name="realPassword"  maxLength="64"/></td>
    </tr>
    <tr> 
	...
	<tr><td colspan="3"; size=18px; style="color:red">注意：由于您的密码过于简单，请立刻修改密码；密码要求英文+数字混合，并且长度大于等于8位</td></tr>
   </TABLE>
<script>
   function doAction(form){
     ...
     if (v.exec()) {
 	  ...
 	  form['realPassword'].value=form['password'].value;
