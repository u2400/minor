...
<body>
	...
	<#else>
	 <center><h1><font color="red">请配置“<a href="#" onclick="addSchemeForm();">教学日历方案</a>”。</font></h1></center>
	 <form name="schemeListForm" method="post" action="" targer="main" onsubmit="return false;"></form>
	<script>
        var bar = new ToolBar('calendarFrameBar','教学日历管理',null,true,true);
        bar.addItem("新增日历方案","addSchemeForm()",'update.gif');
